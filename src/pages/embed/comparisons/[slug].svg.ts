...
<svg xmlns="http://www.w3.org/2000/svg" width="384" height="${height}" viewBox="0 0 384 ${height}" role="img" aria-label="${escapeXml(title)}">
  ...
  <g font-family="system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif">
    <text x="24" y="28" font-size="10" font-weight="600" fill="#a78bfa" letter-spacing="1.2">AIPEDIA.WIKI</text>
    ...
    <g transform="translate(24, ${88 + tools.length * 28})">
      <rect x="0" y="-14" width="336" height="28" rx="6" fill="rgba(167,139,250,0.12)" stroke="rgba(167,139,250,0.3)" stroke-width="1"/>
      <text x="12" y="4" font-size="12" font-weight="600" fill="#a78bfa">${escapeXml(verdict)}</text>
