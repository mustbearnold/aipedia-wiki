...
export const GET: APIRoute = async () => {
  ...
  lines.push('');
  lines.push('Recent maintenance: June 6, 2026 refreshed the interview-prep, archived legal-research, LinkedIn, logo-design, email-writing, Excel/spreadsheets, professional-headshot, Instagram, cold-email, cover-letter, data-analysis, debugging, book-writing, brainstorming, citations, code-review, academic-writing, ad-copy, API-documentation, and blog-writing buyer guides plus AI Writing, AI Design, AI Automation, AI Research, AI Coding, Answers, /guides/, homepage, categories, and LLM surfaces around ethical interview prep, legal AI noindex criteria, LinkedIn authenticity, logo trademark/vector risk, inbox drafting, spreadsheet verification, likeness trust, social creative workflows, outbound credits, job-application privacy, data-workflow reproducibility, Copilot AI Credits, manuscript workflow limits, source-grounded brainstorming, citation integrity, PR review billing, ad creative credits, docs/SDK/MCP tooling, Jasper credits, and Surfer SEO positioning.');
  lines.push('');
