...
const useCases = defineCollection({
  ...
  schema: z.object({
    ...
    intent_type: z.enum(['best-of', 'specific-workflow', 'alternative', 'workflow', 'stack', 'plan-guide', 'comparison-support']).optional(),
    primary_tool: z.string().optional(),
    affiliate_tools: z.array(z.string()).optional(),
    commercial_tools: z.array(z.string()).optional(),
    configured_affiliate_tools: z.array(z.string()).optional(),
    competitor_tools: z.array(z.string()).optional(),
    external_competitors: z.array(z.string()).optional(),
    buyer_job: z.string().optional(),
    audience: z.string().optional(),
    not_for: z.array(z.string()).optional(),
    decision_criteria: z.array(z.string()).optional(),
    search_intent: z.string().optional(),
    conversion_angle: z.string().optional(),
    unique_angle: z.string().optional(),
    sibling_cluster: z.string().optional(),
    overlap_guard: z.string().optional(),
    cta_plan: z.object({
      primary: z.string().min(1),
      secondary: z.string().min(1),
      disclosure: z.string().min(1),
    }).optional(),
    canonical_parent: z.string().optional(),
    ...
    freshness_window_days: z.number().optional(),
    volatile_claims: z.array(z.string()).optional(),
    monetization_disclosure_required: z.boolean().optional(),
    indexability_reason: z.string().optional(),
