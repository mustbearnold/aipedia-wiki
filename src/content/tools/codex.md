...
best_for:
  ...
  - users already paying for ChatGPT Pro or Plus
  - multi-file refactors across a full codebase
  - teams wanting OpenAI plugin ecosystem depth
  - workflows that benefit from Computer Use + Memory
not_best_for:
  - Linux-first developers who need a desktop GUI today
  - primary daily-driver IDE coding (Cursor fits better)
...
price_history:
  ...
  - date: 2026-05-11
    ...
    price: "Bundled with paid ChatGPT tiers; Trusted Access tiers gated"
    source: "https://developers.openai.com/codex/pricing"
    source_label: "Source"
    source_id: codex-pricing
...
- **May 11, 2026:** [OpenAI consolidated its commercial operations under an OpenAI Deployment Company](/news/2026-05-11-openai-deployment-company-launch/). The restructure cleans the path for enterprise distribution of Codex, ChatGPT, and Daybreak across hyperscalers and government customers.
...
- **May 7, 2026:** [OpenAI shipped Realtime 2 with two new voice models](/news/2026-05-07-openai-realtime-2-voice-models/). The lower-latency bidirectional stack tightens voice-driven Codex workflows for hands-free coding sessions and dictation in Codex Desktop.
...
Every data point verified 2026-05-22 against OpenAI's Codex docs, pricing pages, the Daybreak / Codex Security announcement, May 21 release notes, and multi-source coverage.
...
| | OpenAI Codex | [Claude Code](/tools/claude-code/) | [Cursor](/tools/cursor/) | [Devin](/tools/devin/) |
|---|---|---|---|---|
...
- **May 7, 2026:** [OpenAI shipped Realtime 2 with two new voice models](/news/2026-05-07-openai-realtime-2-voice-models/), reducing latency for Codex dictation and hands-free sessions in Codex Desktop.
...
- **April 28, 2026:** [Codex available on Amazon Bedrock](/news/2026-04-28-openai-models-codex-managed-agents-aws/) via limited preview, with Codex CLI, the desktop app, and the VS Code extension all configurable to use Bedrock as the provider.
...
**What is Memory?**
Persistent context across Codex sessions. Remembers your preferences, corrections, and project setup so you don't re-explain environment details each time. Launched April 16, 2026 on the ChatGPT-signed-in Codex Desktop.

**Can Codex operate other apps?**
Yes via Computer Use (April 16, macOS first). Codex sees the screen, controls a virtual cursor, clicks, and types. Useful when MCP plugins or APIs don't exist for your target app.

**Is there a team tier?**
Yes. ChatGPT Business at $25/user/mo. Plus Codex-only seats with pay-as-you-go token billing for teams that want Codex without full ChatGPT per-user costs.
...
- [Apidog: Cursor vs OpenAI Codex](https://apidog.com/blog/cursor-vs-codex-comparison-2026/)
