...
- **Page-style documents and mixed workflows:** [Obsidian](/tools/obsidian/). Page-centric model with optional outliner plugins.
- **Team collaboration, shared databases, real-time:** [Notion AI](/tools/notion-ai/). Logseq is single-user.
- **Free single-source research Q&A:** [NotebookLM](/tools/notebooklm/).
- **Polished mobile-first note-taking:** Apple Notes or Bear. Logseq mobile is usable but basic.
- **AI-native notes out of the box:** [Notion AI](/tools/notion-ai/) or Obsidian with Copilot plugin + Claude key.
...
<details>
<summary>What about Roam Research?</summary>
...
<details>
<summary>Can I import my Obsidian vault?</summary>
...
- **Also see:** [Obsidian](/tools/obsidian/) (page-based local-first alternative) · [Notion AI](/tools/notion-ai/) (team workspace) · [NotebookLM](/tools/notebooklm/) (research Q&A)
