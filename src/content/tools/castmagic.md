...
title: Castmagic
tagline: >-
  AI content factory for podcasters and creators. One audio upload becomes show notes, timestamped chapters, blog posts, social threads, newsletters, and more.
category: ai-writing
...
facts:
  best_for:
    value: "Castmagic is best for podcasters, video creators, and B2B teams who record long-form audio or video and want the post-production content package (show notes, social posts, blog draft, newsletter) generated automatically instead of paying an editor or VA."
  ...
  team_features:
    ...
    confidence: high
  watch_out_for:
    value: "Castmagic charges by audio hours, not output count, so creators who batch-record (e.g. 4-hour interview days) hit the Hobby cap fast; the Starter and Business jumps are steep relative to the 4x quota increases."
    source: "https://www.castmagic.io/pricing"
    source_label: "Castmagic pricing"
    source_id: castmagic-pricing
    verified_at: 2026-06-12
...
Every data point above was verified against Castmagic pricing and product documentation on 2026-06-12. See Sources.
...
Prices verified 2026-06-12 via [castmagic.io/pricing](https://www.castmagic.io/pricing). Audio-hour overage requires a plan upgrade; there is no published per-hour overage rate.
...
Yes, on the Business tier. The API is used to wire generation into CMS, marketing automation, or custom internal tools.
...
- [Castmagic product overview](https://www.castmagic.io/): Output formats, Magic Chat, Longform AI, Prompt Builder
- [Castmagic help center](https://help.castmagic.io/): Feature mechanics and supported workflows
