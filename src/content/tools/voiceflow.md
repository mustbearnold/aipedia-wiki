...
facts:
  best_for:
    ...
    confidence: medium
  pricing_anchor:
    value: "Pricing page remains demo-gated and usage-based as of June 2026; previously published per-editor rates (Sandbox free, Pro $60/editor, Teams $150/editor) are no longer publicly displayed and must be confirmed with sales."
    source: "https://www.voiceflow.com/pricing"
    source_label: "Source"
    source_id: voiceflow-pricing
    verified_at: 2026-06-12
    ...
    confidence: medium
  watch_out_for:
    value: "Voiceflow no longer publishes a public pricing tier sheet; pricing is usage-based and demo/agency-trial led. Buyers should request a written quote covering credits, editor seats, voice/phone usage, model-provider costs, and overage before signing."
    source: "https://www.voiceflow.com/pricing"
    source_label: "Source"
    source_id: voiceflow-pricing
    verified_at: 2026-06-12
...
seo_title: "Voiceflow: Features, Pricing & Review (June 2026)"
meta_description: >-
  Voiceflow is a no-code AI agent builder for conversational apps with a visual canvas, knowledge-base RAG, and deployment to chat, voice, and custom channels. Pricing is demo-gated and usage-based in June 2026.
...
>
> **Who pays which tier:** Start with the free trial for agency/client prototypes. Production buyers should request a written usage quote that separates workspace/editor access, agent credits or interactions, phone/voice usage, model-provider costs, and support/compliance terms.
...
| **LLM support** | Access to major model providers and bring-your-own provider routes where configured |
| **Knowledge base** | PDF · URL · document ingest · RAG grounding |
| **Pricing** | Free agency trial · usage-based demo-gated quotes · historical Pro/Teams baselines require sales confirmation |
| **Credits/interactions** | Quote-required; old public credit allowances should not be treated as current guarantees |
| **Extra seats** | Quote-required; old extra-seat fees should be confirmed before renewal |
...
As of June 2026, [voiceflow.com/pricing](https://www.voiceflow.com/pricing) no longer publishes a tier sheet. The page describes usage-based billing with a free agency trial and a demo-gated business path. Get a written quote covering credits or interactions, editor seats, phone/voice usage, model-provider costs, support, and overage before signing. Annual billing and extra-seat assumptions should be confirmed in the quote instead of copied from older public pricing.

| Historical buyer baseline | Monthly | Credits | Key limits | How to use this now |
|------|---------|---------|-----------|--------------|
| Sandbox/free trial | $0 historically | ~1,000/mo historically | 2 agents, 1 editor, older model access | Use only for testing; verify current trial limits |
| Pro | ~$60/editor historically | ~10,000/mo historically | 20 agents, advanced models, 30-day version history | Baseline for quote review, not a current public price |
...
- **No public pricing.** As of June 2026 Voiceflow's pricing page no longer lists Sandbox, Pro, or Teams tier rates. Buyers should expect a demo-gated quote process and confirm credit allowances, editor seat costs, voice/phone usage, model-provider costs, and overage rates in writing before signing.
...
**Is Voiceflow free?**
Yes. A free agency trial is available with no credit card. Historically the Sandbox plan provided 1,000 credits/month, 2 agents, and 1 editor seat. Confirm current free-tier limits during the demo flow at [Voiceflow pricing](https://www.voiceflow.com/pricing).

**How much does Voiceflow cost?**
Pricing is no longer published on the vendor's public page as of June 2026; Voiceflow has shifted to demo-gated, usage-based quotes. Last publicly confirmed rates (April 2026): Pro at $60/editor/month with 10,000 credits and Teams at $150/editor/month with 30,000 credits. Extra editor seats historically ran $50/month. Confirm current usage, model, phone/voice, and overage terms in writing ([Voiceflow pricing](https://www.voiceflow.com/pricing)).
...
Voiceflow is LLM-native and ships modern RAG tooling. Dialogflow is Google's older intent-based platform, better suited to scripted bots and Google Cloud integration. Teams that want a no-code visual builder across major model providers usually pick Voiceflow.
...
- [Voiceflow pricing](https://www.voiceflow.com/pricing): current pricing posture, free trial, and usage-based quote path
