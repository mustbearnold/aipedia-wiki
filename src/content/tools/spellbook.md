...
facts:
  ...
  pricing_anchor:
    ...
    confidence: high
  watch_out_for:
    value: "No public fixed per-seat price. Official pages contain mixed model-marketing text, so verify current model routing, data terms, and quote details before procurement."
