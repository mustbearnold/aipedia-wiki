...
title: AIVA
tagline: >-
  AI music composition specialist for classical, orchestral, and cinematic scores. Exports MIDI
  and stems for DAW editing, unlike pop-focused generators that only return rendered audio.
category: ai-music
...
facts:
  ...
  pricing_anchor:
    value: AIVA prices in EUR with Free, Standard (EUR 11/mo annual), and Pro (EUR 33/mo annual) tiers; verify download caps, copyright, monetization, and monthly limits on the live pricing page.
  ...
  open_source_or_local:
    ...
    next_review_at: '2026-11-13'
  enterprise_controls:
    value: AIVA's EULA routes enterprise, high-volume, private-API, large-scale licensing/database, and model-training uses to separate licensing rather than the self-serve individual plans.
...
meta_description: >-
  ...
  Pro covers individual/small-business copyright ownership; larger or high-volume uses need AIVA licensing.
author: "aipedia.wiki Editorial"
best_for:
  - orchestral and cinematic score drafts
  - film, game, and trailer composers needing MIDI to edit
  - classical-adjacent instrumental beds
  - royalty-free background music for video
not_best_for:
  - pop songs with vocals
  - lyric generation
  - modern electronic or hip-hop production
  - users needing a public API
quick_answer: >-
  AIVA is the composition-first AI music tool for orchestral and cinematic work. Pick it when
  MIDI and stem export into a DAW matter more than finished vocal tracks. Skip for pop,
...
price_history:
  - date: 2026-04-15
    plan: "Pro"
    price: "EUR 33/mo annual effective"
    source: "https://www.aiva.ai/pricing"
    source_label: "AIVA pricing"
    source_id: aiva-pricing
    note: "Historical row corrected to EUR-denominated annual effective pricing during the June 18, 2026 refresh."
  - date: 2026-04-15
    plan: "Standard"
    price: "EUR 11/mo annual effective"
    source: "https://www.aiva.ai/pricing"
    source_label: "AIVA pricing"
    source_id: aiva-pricing
    note: "Historical row corrected to EUR-denominated annual effective pricing during the June 18, 2026 refresh."
  - date: 2026-05-13
    ...
    source_label: "AIVA pricing"
    source_id: aiva-pricing
    note: "Re-verified June 18, 2026. Pricing is EUR-denominated on the live annual page. Pro grants copyright ownership for individual/small-business use, 300 downloads/mo, 5:30 max track length, WAV/MP3/MIDI/stems."
  - date: 2026-05-13
    plan: "Standard"
    ...
    source_label: "AIVA pricing"
    source_id: aiva-pricing
    note: "Re-verified June 18, 2026. Standard track length is 5 min, with 15 downloads/mo. Monetization limited to YouTube, Twitch, TikTok, Instagram."
  - date: 2026-05-13
    plan: "Free"
    price: "EUR 0"
    source: "https://www.aiva.ai/pricing"
    source_label: "AIVA pricing"
    source_id: aiva-pricing
    note: "Re-verified June 18, 2026. Free tier exports MP3 and MIDI, 3 downloads/mo, 3 min max track length, non-commercial only, AIVA attribution required."
  - date: 2026-06-01
    ...
    source_label: "AIVA pricing"
    source_id: aiva-pricing
    note: "Rechecked against the live pricing page. Free remains 3 downloads/month with MP3+MIDI; Standard remains EUR 11/month annual; Pro remains EUR 33/month annual with copyright ownership for individual/small-business use and 300 downloads/month."
---
...
- **Songs with vocals and lyrics:** [Suno](/tools/suno/) or [Udio](/tools/udio/). AIVA does not generate vocals at all.
- **Royalty-safe ambient loops and background tracks:** [Mubert](/tools/mubert/). Purpose-built for streaming and YouTube background use.
- **Sound design, loops, and a public API for automation:** [Stable Audio](/tools/stable-audio/). AIVA has no public API.
...
*Prices verified 2026-06-18 via [AIVA pricing](https://www.aiva.ai/pricing). The Free tier includes MIDI download alongside MP3. Standard supports 5-minute tracks. Educational and enterprise licenses are quoted separately.*
...
This page was produced by the aipedia.wiki editorial pipeline, an automated system that ingests vendor documentation, verifies pricing and model details against primary sources, and generates the editorial analysis you are reading. No individual human wrote this review. Scoring follows the four-dimension rubric at [/about/scoring/](https://aipedia.wiki/about/scoring/) (Utility, Value, Moat, Longevity, unweighted average). Last verified 2026-06-18 against [aiva.ai](https://www.aiva.ai), [aiva.ai/pricing](https://www.aiva.ai/pricing), [AIVA's EULA](https://www.aiva.ai/legal/1), [AIVA Helpdesk](https://aiva.crisp.help/en/category/frequently-asked-questions-1hnn93r/), and [AIVA's Lyra blog](https://blog.aiva.ai).

## FAQ

**Is AIVA free to use?**
Yes. The Free tier is EUR 0 and exports MP3 plus MIDI tracks up to 3 minutes, capped at 3 downloads per month for non-commercial use with AIVA attribution. Paid tiers unlock commercial rights and remove the attribution requirement ([AIVA pricing](https://www.aiva.ai/pricing)).

**Does AIVA do vocals or lyrics?**
...
**What is Lyra?**
Lyra is AIVA's private-beta instrumental foundation model described on the official blog. It supports natural-language prompts and 30-second to 10-minute complete compositions, but it should not be treated as a public-plan feature until AIVA exposes it in the product or pricing surface.
...
- [AIVA official site](https://www.aiva.ai): product overview, styles, and editor
- [AIVA pricing](https://www.aiva.ai/pricing): Free, Standard, and Pro tier details
- [AIVA EULA](https://www.aiva.ai/legal/1): licensing scope, enterprise/custom licensing, API, high-volume, and training-data restrictions
- [AIVA Helpdesk licensing FAQ](https://aiva.crisp.help/en/article/i-dont-understand-the-terms-of-license-1wqvh5v/): plan-specific copyright and monetization summary
- [AIVA Helpdesk format FAQ](https://aiva.crisp.help/en/article/what-formats-can-i-download-the-music-in-1ppr6no/): MP3, MIDI, WAV, stems, and chord text export formats
- [AIVA Lyra blog](https://blog.aiva.ai): Lyra, OmniCodec, ORAQL, Influence, and private beta direction
