...
quick_answer: >-
  Grok Code Fast 1 is xAI's speed-oriented coding model. Pick it for low-latency developer workflows and agent loops. Skip it if your priority is mature IDE distribution, long-context codebase reasoning, or the strongest general-purpose model.
---
...
| Pricing | API/token pricing varies |
