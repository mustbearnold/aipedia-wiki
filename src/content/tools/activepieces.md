...
meta_description: >-
  ...
  then $5/flow/month. Verified June 25, 2026.
...
*Prices verified 2026-06-25 via [activepieces.com/pricing](https://www.activepieces.com/pricing). Pricing is currently per active flow on Standard; the current GitHub releases page showed 0.85.4 shipping on June 17, 2026.*
...
Yes, but do not read it as "every catalog piece is guaranteed." On June 25, 2026, the pricing page included unlimited MCP servers, the MCP page showed 754 MCP listings, and the docs listed MCP tools for flow discovery, editing, validation, testing, and publishing.
...
- [Activepieces pricing](https://www.activepieces.com/pricing): plan structure, per-flow cost (verified 2026-06-25)
- [Activepieces GitHub](https://github.com/activepieces/activepieces): MIT license, codebase, MCP positioning (verified 2026-06-25)
- [Activepieces self-hosting docs](https://www.activepieces.com/docs/install/overview): Docker Compose, Postgres, Redis setup (verified 2026-06-25)
- [Activepieces MCP page](https://www.activepieces.com/mcp): public MCP count and setup flow (verified 2026-06-25)
- [Activepieces MCP tools docs](https://www.activepieces.com/docs/mcp/tools): flow discovery, editing, validation, testing, and table tools exposed through MCP (verified 2026-06-25)
- [Activepieces pieces catalog](https://www.activepieces.com/pieces): live piece count and integration categories (verified 2026-06-25)
