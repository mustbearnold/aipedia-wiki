...
Every data point above was re-verified as still discontinued against reporting on 2026-06-27. See Sources.
...
*Shutdown verified 2026-06-27 via [VentureBeat coverage](https://venturebeat.com/technology/tomes-founders-ditch-viral-presentation-app-with-20m-users-to-build-ai) and [Lightfield](https://lightfield.com).*
...
This page was produced by the aipedia.wiki editorial pipeline, an automated system that ingests vendor documentation, verifies pricing and model details against primary sources, and generates the editorial analysis you are reading. No individual human wrote this review. The tool is marked dead because the original product shut down on April 15, 2025. Last verified 2026-06-27 against [VentureBeat coverage of the Lightfield pivot](https://venturebeat.com/technology/tomes-founders-ditch-viral-presentation-app-with-20m-users-to-build-ai).
