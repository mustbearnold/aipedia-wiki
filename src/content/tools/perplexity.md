...
quick_answer: >-
  Perplexity is an AI-native search and answer engine. The free tier synthesizes cited answers using Sonar (Perplexity's own Llama-tuned search model) with roughly 3-5 Pro searches per day. Pro at $20/mo unlocks unlimited Pro searches, a per-query model switcher across GPT-5.4, Claude Opus 4.7, Gemini 3.1 Pro, and Grok, Deep Research that exports directly to PowerPoint and spreadsheets, Spaces (file-grounded workspaces, up to 50 files), and Voice Mode. Max at $200/mo adds Model Council (same query against three frontier models, synthesized) and Perplexity Computer (cloud agent over 19 models and 400+ tools). Enterprise runs $40/user (Pro) to $325/user (Max) with SSO, admin controls, and Spaces capped at 500 files. The Comet browser is free across iOS, Android, Mac, and Windows. Best for cited research; not a replacement for ChatGPT or Claude on writing or coding.
price_history:
  - date: 2026-03-18
    plan: "Comet browser"
    price: "$0"
...
> **Pick Perplexity if you need cited, verifiable answers from the live web.** Nothing else in the consumer-AI market surfaces sources as aggressively or as cleanly. Pro at $20/mo is the right default for researchers, journalists, analysts, and anyone doing due diligence who needs to see where a claim came from.
>
...
>
> **Who pays which tier:** Free for casual fact-checks, Pro $20/mo for regular cited research (the sweet spot), Max $200/mo only if you actually use Model Council or Perplexity Computer weekly, Enterprise Pro $40/user for teams that need Spaces with SSO, Enterprise Max $325/user for compliance-heavy orgs running Computer workloads at scale.
...
| **Pricing** | Free · Pro $20 · Max $200 · Enterprise Pro $40/user · Enterprise Max $325/user |
