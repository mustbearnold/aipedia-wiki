...
slug: uizard
title: Uizard
tagline: Miro-owned AI UI design tool for fast editable mockups. Autodesigner 2.0 turns prompts into prototypes, while Screenshot Scanner and Wireframe Scanner turn references into editable screens.
category: ai-design
...
seo_title: "Uizard Review: Pricing, Autodesigner & Limits (June 2026)"
meta_description: "Uizard is Miro's AI UI mockup tool. Verified June 2026: Free gets 3 AI generations/mo, Pro is $12/mo billed annually, Business is $39/mo billed annually, and React/CSS handoff is per component."
...
facts:
  best_for:
    value: "Miro-owned AI UI design tool for fast editable mockups. Autodesigner 2.0 turns prompts into prototypes, while Screenshot Scanner and Wireframe Scanner turn screenshots or sketches into editable screens."
    ...
    confidence: high
  pricing_anchor:
    value: "Pro; $12/mo when billed annually; 500 AI generations/month; paid plans unlock Autodesigner 2.0 and developer handoff"
    ...
    confidence: high
  watch_out_for:
    value: "Handoff Mode exposes React/CSS for individual components, not a full HTML/JavaScript/project export; teams should also verify Enterprise data terms before uploading sensitive product designs."
...
best_for:
  ...
  - product managers mocking up flows for stakeholder review
  - converting hand-drawn sketches or screenshots into editable designs
  - early-stage prototyping before moving to Figma
  - solo founders validating ideas without a designer
not_best_for:
  - production-grade design systems
  - pixel-accurate vector work
  - handoff-heavy engineering workflows requiring design tokens
  - mature design teams already on Figma
quick_answer: >-
...
price_history:
  - date: 2026-06-10
    ...
    source_id: uizard-pricing
    verified_at: 2026-06-25
    note: "Reverified unchanged. Official pricing lists 3 AI generations/month, Autodesigner 1.5, 2 projects, and 10 free templates."
  - date: 2026-06-10
    plan: "Pro"
    ...
    source_id: uizard-pricing
    verified_at: 2026-06-25
    note: "Reverified unchanged. Official pricing lists 500 AI generations/month, Autodesigner 2.0, developer handoff for React/CSS, up to 100 projects, private projects, and all templates."
  - date: 2026-06-10
    plan: "Business"
    ...
    source_id: uizard-pricing
    verified_at: 2026-06-25
    note: "Reverified unchanged. Official pricing lists 5,000 AI generations/month, faster AI generation, custom brand kit, unlimited projects, and priority support."
  - date: 2026-06-10
    plan: "Enterprise"
    price: "Custom"
    source: "https://uizard.io/pricing/"
    ...
    source_id: uizard-pricing
    verified_at: 2026-06-25
    note: "Reverified unchanged. Official pricing lists 15+ seats, unlimited AI generations, unlimited teams, design-system setup, AI data SLA, custom billing, and white-glove onboarding."
  - date: 2026-05-10
    plan: "Pro"
    price: "$12/mo billed annually"
    source: "https://uizard.io/pricing/"
  ...
  - date: 2026-04-18
    ...
    source_id: uizard-pricing
    verified_at: 2026-06-25
    note: "Historical check; refreshed on 2026-05-10 with annual-billing wording from the current pricing page."
  - date: 2026-04-18
    plan: "Business"
    price: "$39/mo billed annually"
    source: "https://uizard.io/pricing/"
...
Uizard was founded in 2018 out of Copenhagen PhD research into AI-assisted UI generation. Miro acquired the company in May 2024. As of this June 25, 2026 refresh, Uizard still has its own public app, support center, and pricing page at uizard.io, so buyers should treat it as Miro-owned but operationally separate from a standard Miro workspace until their account rep confirms otherwise.
...
- **Mature design team or production design system:** [Figma](/tools/figma/). Uizard's component model is coarser and tokens are thinner.
- **AI UI generation with a different exploration model:** [Google Stitch](/tools/google-stitch/) is better for experimental AI-native canvas work, while [v0](/tools/v0/) is better when the buyer wants React code rather than a mockup.
- **Web-specific design and live publishing:** [Framer AI](/tools/framer-ai/). Uizard produces mockups, Framer produces live sites.
- **Marketing graphics, social posts, or general design:** [Canva](/tools/canva/). Different problem, different tool.

## Pricing

Pricing via [uizard.io/pricing](https://uizard.io/pricing/):
...
Prices verified 2026-06-25 via [Uizard pricing page](https://uizard.io/pricing/). Uizard's support page still uses $19/month as a Pro monthly billing example, but the durable public pricing page emphasizes annual billing for the displayed $12 and $39 rates; verify checkout pricing before buying monthly seats.
...
This page was refreshed on 2026-06-25 by checking Uizard's pricing page, Autodesigner page, and help center export docs, with previous scanner, subscription, and Miro acquisition sources retained for context. Scoring follows the four-dimension rubric at [/about/scoring/](https://aipedia.wiki/about/scoring/) (Utility × Value × Moat × Longevity, unweighted average). The most volatile fields are pricing, generation allowances, handoff/export scope, and Enterprise data terms.

## FAQ

**Is Uizard still independent after the Miro acquisition?**
As of June 25, 2026, Uizard ships at uizard.io with its own public pricing and support docs, while Uizard's own May 2024 post says it joined Miro. Treat it as Miro-owned but verify exact Miro workspace, billing, SSO, and data terms before procurement.
...
**Can Uizard output real frontend code?**
Pro tier and above expose React and CSS in Handoff Mode for individual components. Uizard's help center says full-project export to HTML, JavaScript, or script is not available, so treat code output as developer reference rather than production scaffolding.
...
- [Using Screenshot Scanner](https://support.uizard.io/en/articles/7915206-using-screenshot-scanner) (verified 2026-06-25)
- [Using Wireframe Scanner](https://support.uizard.io/en/articles/6435370-using-wireframe-scanner) (verified 2026-06-25)
- [Exporting projects and Handoff Mode](https://support.uizard.io/en/articles/6380330-exporting-projects) (verified 2026-06-25)
- [Importing screens from Figma, Adobe, or Sketch](https://support.uizard.io/en/articles/6912011-importing-screens-from-figma-adobe-or-sketch) (verified 2026-06-25)
- [Understanding subscriptions](https://support.uizard.io/en/articles/6249189-understanding-subscriptions) (verified 2026-06-25)
- [Uizard joins Miro](https://uizard.io/blog/uizard-joins-miro/) (verified 2026-06-25)
...
- 2026-06-25: Reverified Free, Pro, Business, and Enterprise prices, AI generation caps, Autodesigner 2.0 positioning, and component-level React/CSS handoff scope. No material pricing change.
