...
slug: uizard
title: Uizard
tagline: Miro-owned AI UI design tool. Autodesigner 2.0 generates full multi-screen mockups from text prompts, plus screenshot-to-mockup and sketch-to-wireframe scanners.
category: ai-design
...
seo_title: "Uizard: Features, Pricing & Review (2026)"
meta_description: "Uizard (now owned by Miro) generates full UI mockups from text prompts via Autodesigner 2.0. Free tier gets 3 AI generations/mo. Pro $12/mo annual, Business $39/mo. Figma plugin and React/CSS export included."
...
quick_answer: >-
  Uizard is a Miro-owned AI design tool that turns text prompts, screenshots, or hand sketches into editable multi-screen UI mockups via Autodesigner 2.0. Pick it for first-draft wireframes when you are not a designer. Skip it if you need a production-grade design system or pixel-level control.
price_history:
  - date: 2026-04-18
    plan: "Pro"
...
- **AI UI generation with higher fidelity output:** [Galileo AI](/tools/galileo-ai/) or [Google Stitch](/tools/google-stitch/) ship closer-to-production visuals.
...
Prices verified 2026-04-18 via [Uizard pricing page](https://uizard.io/pricing/).
...
This page was produced by the aipedia.wiki editorial pipeline, an automated system that ingests vendor documentation, verifies pricing and feature claims against primary sources, and generates the editorial analysis you are reading. No individual human wrote this review. Scoring follows the four-dimension rubric at [/about/scoring/](https://aipedia.wiki/about/scoring/) (Utility × Value × Moat × Longevity, unweighted average). Last verified 2026-04-18 against [Uizard pricing](https://uizard.io/pricing/), the [Uizard product site](https://uizard.io/), and [Crunchbase's Miro acquisition record](https://www.crunchbase.com/acquisition/mirohq-acquires-uizard-technologies--3f732879).

## FAQ

**Is Uizard still independent after the Miro acquisition?**
As of April 2026, Uizard ships as a standalone product at uizard.io with its own pricing and login, though it is owned by Miro (acquired May 2024). Deeper integration with Miro's platform is in development but not yet the primary workflow.
...
Pro tier and above export React and CSS for individual screens. The output is scaffolding: useful as a starting point for frontend developers but not a production-ready build. Expect to add state management, routing, and accessibility manually.
