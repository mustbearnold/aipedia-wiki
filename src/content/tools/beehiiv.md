...
title: Beehiiv
tagline: >-
  Newsletter platform for creator-owned publishing. Pairs newsletters, websites, podcasts,
  AI writing, auto-translation, MCP operations, referrals, ads, Boosts, digital products,
  webinars, and premium subscriptions.
category: ai-writing
...
facts:
  ...
  pricing_anchor:
    value: beehiiv pricing depends on subscriber count, publication count, automation, monetization, MCP write access, API needs, and AI-credit burn; Launch is free, paid monthly billing starts at $49/month, annual starting prices show Scale at $43/month and Max at $96/month, and the pricing table currently exposes daily AI Credit Limits of 10, 25, 50, and 100 by tier.
...
Beehiiv is a newsletter platform for publishing, audience growth, and monetization. The product bundles an editor, a native ad network, referral-program mechanics, subscriber analytics, premium-subscription support, podcasts, digital products, webinars, Beehiiv AI, and MCP access across a single stack.
...
| **Deliverability** | Optimized deliverability is included; dedicated IP addresses are Enterprise |
