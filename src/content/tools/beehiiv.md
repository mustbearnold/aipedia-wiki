...
title: Beehiiv
tagline: >-
  Newsletter platform built by ex-Morning Brew operators. Pairs publishing tools with an AI
  writer, auto-translation, referral mechanics, and a built-in monetization stack (ads, Boosts,
  premium subs).
category: ai-writing
...
affiliate:
  ...
  link: null
  notes: "Official beehiiv partner page verified 2026-06-23: up to 60% for 12 months, 60-day cookie, apply via beehiiv partner page."
scores:
  utility: 8
  value: 8
  moat: 7
...
facts:
  best_for:
    value: Best for newsletter operators who want publishing, audience growth, monetization, AI-assisted writing, and MCP-connected AI operations in one newsletter platform.
  ...
  pricing_anchor:
    value: beehiiv pricing depends on subscriber count, publication count, automation, monetization, MCP write access, and API needs; Launch is free, paid monthly billing starts at $49/month, and annual starting prices show Scale at $43/month and Max at $96/month.
  ...
  api_available:
    value: beehiiv publishes developer documentation with API reference pages for posts, publications, subscribers, automations, segments, webhooks, OAuth, and monetization-related resources; Enterprise still gates the Send API.
    ...
    next_review_at: '2026-11-13'
  workflow_surface:
    value: "The workflow surface has expanded from newsletter growth and monetization into MCP-driven AI operations: AI clients can analyze the workspace for all users, while paid plans add write actions for posts, templates, segments, automations, surveys, polls, products, and related assets."
    source: https://www.beehiiv.com/
    source_label: beehiiv official site
    source_id: beehiiv-official
    verified_at: '2026-06-23'
    ...
    next_review_at: '2026-11-13'
  mcp_surface:
    value: beehiiv MCP is available to all users with no waitlist or paid-plan requirement for read access; write actions require a paid plan, and publishing posts or activating automations still happens inside the beehiiv app.
  ...
  product_updates:
    value: Recent product updates added MCP v2, June 16 MCP write access, webinars, podcast pages and hosting, Automations v4, On-Demand Ads, Dynamic Content, digital products v2, and broader media-library and website-builder controls.
...
meta_description: >-
  Beehiiv review: newsletter OS with AI Writer, MCP, ads, Boosts, digital products, podcasts, webinars, and paid subscriptions. Launch is free; paid plans start at $49/mo monthly.
author: "aipedia.wiki Editorial"
best_for:
  - creator-owned newsletters scaling past Substack
  - paid newsletters with ads and Boosts
  - teams running multi-publication content ops
  - AI-assisted drafting inside the publishing tool
not_best_for:
  - users who just want free email blasts with no growth tooling
  - enterprise marketing ops needing deep CRM workflows
  - creators whose audience is locked into a specific Substack discovery network
quick_answer: >-
...
price_history:
  ...
  - date: 2026-05-13
    ...
    source_id: beehiiv-pricing
    verified_at: 2026-06-23
    note: "Repricing verified 2026-06-23. Scale now $43/mo ($517/yr), Max $96/mo ($1,151/yr); both tiers cap at 100,000 subscribers. Beehiiv now advertises a 0% take rate on paid subscription revenue and bundles Boosts plus Ad Network into Scale. Max-only adds branding removal, audio newsletters, up to 10 publications, unlimited team seats."
  - date: 2026-06-18
...
Beehiiv is the newsletter platform founded in 2021 by the operators who ran [Morning Brew](https://www.morningbrew.com). The product bundles an editor, a native ad network, referral-program mechanics, subscriber analytics, premium-subscription support, podcasts, digital products, webinars, Beehiiv AI, and MCP access across a single stack.
...
>
> **Who pays which tier:** Launch is free for up to 2,500 subscribers with read-only MCP, the editor, website, podcast tools, and referral network. Scale starts at $49/mo monthly or $43/mo annual-equivalent and adds monetization, automations, webhooks, human support, 3 seats, and MCP write access. Max starts at $109/mo monthly or $96/mo annual-equivalent and adds branding removal, sponsorship storefront, audio newsletters, up to 10 publications, unlimited seats, priority support, Getty credits, and dynamic content. Enterprise is custom and adds dedicated IPs, Send API, SSO, custom publication limits, and VIP support.

## What Changed Since The Last Refresh

The June 23 refresh found that Beehiiv has changed more in workflow than in annual starting price:
...
- MCP write access shipped on June 16, 2026. AI clients can now create and edit posts, build multi-step automations, launch products, polls, and surveys, update templates, add tags, generate image alt text, and update metadata. The official product update keeps the important guardrail: write access is paid-plan only, and publishing posts still stays under operator control in Beehiiv.
...
- **Drafting-only, not publishing:** [ChatGPT](/tools/chatgpt/) or [Claude](/tools/claude/). Stronger general-purpose writing assistants. Export the draft into whatever ESP is already in use.
- **Long-form marketing copy generation:** [Jasper](/tools/jasper/). Dedicated tool for marketing copy workflows across blog, ad, and email.
- **Grammar and tone polish during writing:** [Grammarly](/tools/grammarly/). Runs alongside any platform and handles line-level edits better than Beehiiv AI.
...
Subscription pricing via [beehiiv.com/pricing](https://www.beehiiv.com/pricing). Paid tiers scale with active subscriber count; the figures below are starting prices at low subscriber tiers.
...
*Prices verified 2026-06-23 via [Beehiiv pricing](https://www.beehiiv.com/pricing) and the plan-tier help article. Annual billing discounts the starting monthly equivalent to $43 for Scale and $96 for Max. Both paid plans rise with active subscriber count up to a 100,000-subscriber ceiling, and lists above that move to Enterprise. Run the calculator on the pricing page for an exact number at your list size.*
...
This page was produced by the aipedia.wiki editorial pipeline, an automated system that ingests vendor documentation, verifies pricing and product details against primary sources, and generates the editorial analysis you are reading. No individual human wrote this review. Scoring follows the four-dimension rubric at [/about/scoring/](https://aipedia.wiki/about/scoring/) (Utility, Value, Moat, Longevity, unweighted average). Last verified 2026-06-23 against [beehiiv.com](https://www.beehiiv.com), [beehiiv.com/pricing](https://www.beehiiv.com/pricing), the [plan-tier help article](https://www.beehiiv.com/support/article/23874462928663-plan-types-and-subscriber-plan-tier-pricing), [Beehiiv MCP help](https://www.beehiiv.com/support/article/39255979546263-getting-started-with-the-beehiiv-mcp), [product updates](https://product.beehiiv.com/), and [developer docs](https://developers.beehiiv.com/).

## FAQ

**Is Beehiiv free to use?**
Yes. The Launch plan is $0/mo for up to 2,500 subscribers and includes newsletter, website, podcast, custom domains, unlimited email sends, AI Website Builder, API access except Send API, and MCP read access. Paid tiers add monetization surfaces, webhooks, human support, and MCP write access, and they scale with subscriber count ([Beehiiv pricing](https://www.beehiiv.com/pricing)).

**What does Beehiiv AI do?**
Beehiiv AI is both in-editor assistance and MCP-connected operations. The editor handles drafting, rewriting, translation, summaries, and audience segmentation. MCP connects Beehiiv to AI clients for account analysis and, on paid plans, write actions such as draft creation, templates, tags, automations, surveys, products, and metadata.
...
**How does Beehiiv compare to Kit (ConvertKit)?**
...
Yes. Beehiiv publishes developer documentation with API reference pages for posts, publications, subscribers, automations, segments, webhooks, OAuth, and related resources. The high-throughput Send API is currently an Enterprise feature alongside SSO and dedicated IPs.

**Does Beehiiv MCP replace the API?**
No. Beehiiv's help docs frame the API as the stable developer interface and MCP as the flexible AI-agent surface. Use MCP for AI-client workflows and account operations. Use the API when a predictable integration contract matters.
...
Yes, on Max and Enterprise. Launch and Scale are single-publication.

## Sources

- [Beehiiv official site](https://www.beehiiv.com): product overview and features
- [Beehiiv pricing](https://www.beehiiv.com/pricing): tier details and subscriber-count scaling
- [Beehiiv plan tiers help](https://www.beehiiv.com/support/article/23874462928663-plan-types-and-subscriber-plan-tier-pricing): active-subscriber tier logic, trial terms, plan calculator, and pause rules
- [Beehiiv MCP help](https://www.beehiiv.com/support/article/39255979546263-getting-started-with-the-beehiiv-mcp): MCP availability, read/write access, limitations, and API comparison
- [Beehiiv product updates](https://product.beehiiv.com/): MCP v2, write access, webinars, podcasts, Automations v4, On-Demand Ads, and product launches
- [Beehiiv developer docs](https://developers.beehiiv.com/): API reference, webhooks, OAuth, posts, publications, subscribers, automations, and segments
- [Beehiiv affiliate partner page](https://www.beehiiv.com/partners/affiliate): affiliate commission and cookie terms
