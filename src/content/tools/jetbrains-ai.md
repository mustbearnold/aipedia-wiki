...
|------|-------|-----------|
| AI Free | $0/mo | Limited AI completions and chat; included with IDE |
| AI Pro (annual) | $8.33/mo | Full AI features; billed as $100/year standalone |
| All Products + AI (annual) | $16.67/mo | All JetBrains IDEs + AI; billed as ~$200/year |

> **Verification note:** JetBrains AI pricing confirmed at [jetbrains.com/ai](https://www.jetbrains.com/ai/) as of 2026-04-14. Prices shown are annualized monthly equivalents; JetBrains bills annually.
...
|------|-------|----------------|
| [GitHub Copilot](github-copilot.md) | $10/mo | Works in JetBrains too, stronger model selection |
| [Cursor](cursor.md) | $20/mo | VS Code only, but best AI IDE experience available |
| [Cody](cody.md) | $9/mo | JetBrains plugin with codebase search, not built-in |
| [Tabnine](tabnine.md) | $12/mo | Privacy-first, runs locally in JetBrains |
...
JetBrains includes a limited AI free tier in its IDEs. It provides a reduced number of AI completions and chat interactions. Most active developers will find it insufficient and need the Pro plan.

## Sources

- [Official website](https://www.jetbrains.com/ai/) — verified 2026-04-14
- [JetBrains AI pricing](https://www.jetbrains.com/ai/#plans-and-pricing) — verified 2026-04-14
- [JetBrains AI documentation](https://www.jetbrains.com/help/idea/ai-assistant.html) — verified 2026-04-14
