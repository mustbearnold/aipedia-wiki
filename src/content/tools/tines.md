...
slug: tines
title: Tines
tagline: Security-first workflow automation for IT and SOC teams, with Workbench, AI Agent actions, audit logs, RBAC, flexible hosting, and API-based integrations.
...
facts:
  best_for:
    value: "Security-first workflow automation for IT and SOC teams, with Workbench, AI Agent actions, audit logs, RBAC, flexible hosting, and API-based integrations. Best for workflow automation, agentic operations, and business-process automation."
...
best_for:
  ...
  - IT and compliance workflows
  - audit-trail-grade incident response
  - controlled AI workflows with optional customer-provided models
  - regulated enterprises needing SOC Type II and role-based access
not_best_for:
  - marketing or sales operators wanting cheap consumer automations
  - solo founders on a $0 budget beyond Community tier
  - teams needing a huge 5000+ app integration library (use Zapier)
quick_answer: >-
  Tines is the workflow automation platform security and IT teams pick when audit logs, role-based access, flexible hosting, and controlled AI workflows matter more than app count. Pick it for SOC, IT, compliance, and agentic workflow orchestration. Skip it for low-cost consumer-app glue, where Zapier or Make is cheaper.
price_history:
  - date: 2026-05-13
    plan: "Starter"
...
Tines is the workflow automation platform built for security and IT teams that need every run logged, reviewable, and automation-ready. Founded by former security operators in 2018, Tines is co-headquartered in Dublin and Boston. It reached unicorn status with a $125M Series C in February 2025, bringing total funding to $272M.
...
> **Pick Tines if you run a SOC, IT ops, or compliance function and need automation runs that hold up in audit.** The platform logs actions, supports SSO/SAML and role-based controls, offers flexible hosting on Business and Enterprise, and connects to security systems through templates, APIs, and integrations. Workbench and AI Agent actions add controlled AI interaction on top of the same workflow runtime.
>
...
| | |
|---|---|
| **Flagship AI surfaces** | Workbench, AI Agent action, Story copilot, Automatic mode |
...
Workbench sits on top. Builders can chat with connected data sources and kick off actions in natural language. The AI Agent action is different: it lives inside workflows and can run in Task mode or Chat mode with explicitly configured tools.
...
- **Consumer-app glue on a budget:** [Zapier](/tools/zapier/) or [Make](/tools/make/). 5,000+ integrations and single-digit monthly pricing.
- **Self-hosted open-source automation:** [n8n](/tools/n8n/) or [Activepieces](/tools/activepieces/). Free if you run your own infrastructure.
- **AI-native sales and back-office agents:** [Lindy](/tools/lindy/) or [Gumloop](/tools/gumloop/). Built around LLM-first UX rather than security compliance.
- **Marketing operators wanting a cheap Zap clone:** Zapier or Make again. Tines is overkill.

## Pricing

Pricing via [tines.com/pricing](https://www.tines.com/pricing/):
...
All tiers include unlimited parallel workflow runs. Tines' pricing explainer says enhanced packaging launched for new customers on June 25, 2025, and the current feature-set list is accurate as of May 1, 2026. Business and Enterprise add flexible hosting, advanced workflow/security bundles, and self-hosting. The Tines Startup Program discounts access for companies under 100 employees, under $50M raised, and under 5 years old.
...
| **Integration count** | Templates, security apps, and any API | 5,000+ | 400+ | 1,500+ |
| **Audit-grade logging** | First-class | Basic | Self-hosted only | Basic |
| **Agent mode** | AI Agent action / Workbench | Zapier Agents | AI nodes | AI nodes |
...
Yes. The Community tier is free forever and includes 1 builder, 3 flows, 25,000 events per month, and 50 AI run-time credits. Paid tiers start at $500/mo with Starter.

**What does Tines Workbench do?**
...
Dedicated infrastructure is available on the Enterprise tier. There is no free self-hosted community build. For fully self-hosted open-source automation, use [n8n](/tools/n8n/) or [Activepieces](/tools/activepieces/).

**Which LLM does Tines use?**
Tines says its default AI features use tenant-scoped large language models and lists Anthropic Claude, OpenAI GPT, and Amazon Nova models among available options, with availability depending on tenant region. Starter, Business, and Enterprise customers can bring their own AI model. Custom AI models do not use Tines AI run-time credits, but they still need a separate model/provider setup.

**Does Tines have an API?**
Yes. Tines exposes its own REST API for programmatic control over stories, actions, and runs. It also acts as an API orchestration layer for any upstream or downstream system.

## Related

- **Category:** [AI Automation](/categories/ai-automation/)
- **Alternatives:** [Zapier](/tools/zapier/) · [Make](/tools/make/) · [n8n](/tools/n8n/) · [Activepieces](/tools/activepieces/) · [Gumloop](/tools/gumloop/) · [Lindy](/tools/lindy/)
...
- [Tines security](https://www.tines.com/security/): SOC Type II, audit logs, SSO/SAML, hosting, Trust Center documents
- [Tines about](https://www.tines.com/about/): founder background and 2018 origin
- [Tines Series C release](https://www.prnewswire.com/news-releases/tines-secures-125m-in-series-c-financing-bringing-total-valuation-to-1-125b-302372726.html): $125M Series C, $1.125B valuation, $272M total funding
