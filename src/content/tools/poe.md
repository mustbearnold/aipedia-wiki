...
facts:
  ...
  best_paid_tier:
    ...
    next_review_at: 2026-07-21
  api_available:
    value: "Yes: Poe provides a Creator Platform API with Python SDK, OpenAI-compatible, and REST integration paths; paid models require an active Poe subscription or add-on points"
