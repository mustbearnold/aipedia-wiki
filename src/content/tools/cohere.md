...
price_range: "$0-$10/1M tokens plus dedicated Model Vault instances"
status: active
launched: 2019-06
last_updated: 2026-06-25
last_verified: 2026-06-25
update_frequency: monthly
seo_title: "Cohere: Features, Pricing & Review (June 2026)"
meta_description: "Cohere is now an enterprise AI, retrieval, sovereign deployment, and developer-model platform: Command A+, North Mini Code, Embed v4, Rerank 4, Transcribe, North, and Model Vault."
...
facts:
  ...
  model_control:
    value: Command A+ is Cohere's 218B sparse MoE flagship for reasoning, multimodal document work, tool use, and agentic tasks, while North Mini Code adds a 30B total / 3B active Apache 2.0 coding-model lane.
    source: https://docs.cohere.com/docs/models
    source_label: Cohere models docs
    source_id: cohere-models-docs
    verified_at: '2026-06-25'
    volatility: high
    confidence: high
    next_review_at: '2026-09-12'
  ...
  watch_out_for:
    ...
    confidence: high
    next_review_at: '2026-12-12'
tags: [enterprise, llm, rag, embeddings, rerank, multilingual, private-deployment, cohere, command, aya, north-mini-code, coding-model]
best_for:
...
price_history:
  - date: 2026-06-09
    plan: "North Mini Code"
    price: "Apache 2.0 open weights; API, Hugging Face, OpenRouter, and Model Vault availability"
    source: "https://cohere.com/blog/north-mini-code"
    source_label: "Cohere North Mini Code"
    source_id: cohere-north-mini-code
    verified_at: 2026-06-25
    note: "Cohere launched its first agentic coding model: 30B total parameters, 3B active, 256K total context, 64K max generation, and minimum 1 H100 deployment options."
  - date: 2026-05-20
    plan: "Command A+"
  ...
  - date: 2026-04-24
    plan: "Cohere and Aleph Alpha"
    price: "Planned sovereign-AI combination with Schwarz Group financing commitment"
    source: "https://cohere.com/blog/cohere-alephalpha-join-forces"
    source_label: "Cohere and Aleph Alpha join forces"
    source_id: cohere-aleph-alpha
    verified_at: 2026-06-25
    note: "Cohere and Aleph Alpha announced a planned transatlantic sovereign-AI combination, with Schwarz Group intending to back a Series E round with a €500M structured financing commitment."
---

# Cohere

Enterprise-first LLM platform. **Command A+** (released May 20, 2026) is now the agentic flagship: a 218B-parameter sparse MoE with 25B active parameters, 128K input context, 64K max generation, vision input, reasoning, tool use, and 48-language support under Apache 2.0. **North Mini Code** (released June 9, 2026) is Cohere's first developer model: a 30B total / 3B active MoE coding model with 256K total context, 64K max generation, Apache 2.0 weights, and availability through Hugging Face, Cohere API, OpenRouter, and Model Vault. **Command R+** handles production RAG workloads at $2.50 input / $10 output per million tokens. **Command R7B** runs locally for edge cases. **Embed v4** and **Rerank 4** power one of the strongest dedicated retrieval stacks in the industry.
...
| **Developer model** | North Mini Code · 30B total / 3B active MoE · Apache 2.0 · 256K total context / 64K output |
...
| **Recent business move** | Cohere and Aleph Alpha announced a planned sovereign-AI combination on April 24, 2026 |

Every data point above was verified against vendor sources and re-checked on June 25, 2026. See Sources.
...
One enterprise LLM platform covering generation (Command family), coding-model evaluation (North Mini Code), retrieval (Embed v4), ranking (Rerank 4), transcription (Cohere Transcribe), and a private agent workspace (North). Cohere does not ship a consumer chat app. Buyers are compliance-aware enterprises, not retail users.
...
- **Peak reasoning or finished coding workflows:** [Claude](/tools/claude/), [Claude Code](/tools/claude-code/), [Cursor](/tools/cursor/), or [GitHub Copilot](/tools/github-copilot/). North Mini Code is model infrastructure, not a finished coding assistant.
...
API pricing via [cohere.com/pricing](https://cohere.com/pricing), verified 2026-06-25:

| Plan / Model | Input ($/1M tok) | Output ($/1M tok) | Context | Who's it for |
|---|---|---|---|---|
| Trial API key | Free | Free | Full | Prototyping, rate-limited |
| Command R+ 08-2024 | $2.50 | $10.00 | 128K | **Production RAG workloads** |
| Command R+ enterprise | $1.00 | $3.00 | 128K | Bulk or long-term contracts |
| Command R 08-2024 | $0.50 | $1.50 | 128K | Cost-sensitive chat + RAG |
| Command 06-2024 (legacy) | $1.00 | $2.00 | 4K | Existing customers only |
| Command Light (legacy) | $0.30 | $0.60 | 4K | Existing customers only |
| Embed v4 | Pay-per-token | n/a | 128K | Document + multimodal indexing |
| Rerank 4 | Pay-per-query | n/a | 32K | RAG pipeline reranking |

Model Vault dedicated instances (for isolated VPC or on-prem inference):

| Model | Tier | Hourly | Monthly |
|---|---|---|---|
| Embed v4 | Small | $4.00 | $2,500 |
| Embed v4 | Medium | $5.00 | $3,250 |
| Rerank 3.5 | Medium | $5.00 | $3,250 |
| Rerank 4 Fast | Medium | $5.00 | $3,250 |
| Rerank 4 Pro | Medium | $5.00 | $3,250 |
| Rerank 4 Pro | Large | $10.00 | $6,500 |

Command A+ and North Mini Code managed pricing are not listed clearly on the public pricing page; contact sales, check the API dashboard, or verify the exact provider route before projecting production cost. Enterprise pricing on Command R+ drops input to $1 and output to $3 per 1M tokens, a roughly 60-70% discount from list. Public pricing rows last verified 2026-06-25 via [Cohere pricing](https://cohere.com/pricing) and [Cohere pricing docs](https://docs.cohere.com/docs/how-does-cohere-pricing-work); the Command A+ and North Mini Code releases were re-verified 2026-06-25.
...
| **Multilingual** | 100+ languages, strongest in retrieval-heavy multilingual evals | Strong | Strong |
...
| **Developer model lane** | North Mini Code, open Apache 2.0 coding model | Codex and OpenAI API | Claude Code and Anthropic API |
| **Best viewed as** | Enterprise RAG + sovereignty + open model control | Generalist + consumer | Reasoning + coding specialist |
...
- **Peak reasoning needs testing.** Command A+ is positioned for enterprise agents and RAG-heavy work, but buyers should benchmark it against Claude Opus 4.8 and OpenAI frontier models on their own hardest tasks.
...
This page was produced by the aipedia.wiki editorial pipeline, an automated system that ingests vendor documentation, verifies pricing and model details against primary sources, and generates the editorial analysis you are reading. No individual human wrote this review. Scoring follows the four-dimension rubric at [/about/scoring/](https://aipedia.wiki/about/scoring/) (Utility x Value x Moat x Longevity, unweighted average). Last verified 2026-06-25 against [Cohere pricing](https://cohere.com/pricing), [Cohere models docs](https://docs.cohere.com/docs/models), [Cohere release notes](https://docs.cohere.com/changelog), [North Mini Code](https://cohere.com/blog/north-mini-code), [Command A+](https://cohere.com/blog/command-a-plus), the [Cohere Transcribe page](https://cohere.com/transcribe), and [Cohere and Aleph Alpha's announcement](https://cohere.com/blog/cohere-alephalpha-join-forces).

## FAQ

**Is Cohere free to use?**
Yes for prototyping. Trial API keys are free and rate-limited. Production API keys are pay-as-you-go, but new deployments should check current model rows rather than assuming legacy Command Light availability. Command R+ 08-2024 is listed at $2.50 input / $10 output per million tokens, and enterprise discounts bring R+ down to $1 input / $3 output per million tokens.
...
**What is Model Vault?**
Cohere's dedicated model inference platform, launched September 2025. Enterprises deploy Command, Rerank, and Embed inside isolated VPCs or on-prem infrastructure. Data never leaves the customer network. Pricing starts at $2,500/mo per model per tier.

**How does Cohere compare to OpenAI for RAG?**
Cohere's dedicated retrieval stack (Embed v4 + Rerank 4) outperforms OpenAI embeddings on public cross-lingual and long-document benchmarks. OpenAI wins on consumer chat, image generation, and plugin ecosystem. If retrieval accuracy is the bottleneck, Cohere is the stronger pick.

## Sources

- [Cohere pricing](https://cohere.com/pricing): Production API rates and Model Vault pricing, verified 2026-06-25
- [Cohere release notes](https://docs.cohere.com/changelog): Command A+, North Mini Code, Command R+, R, R7B, Embed, Rerank, and Transcribe updates, verified 2026-06-25
- [Cohere models docs](https://docs.cohere.com/docs/models): current model IDs, context windows, modalities, and deprecation state, verified 2026-06-25
- [Cohere Embed v4 page](https://cohere.com/embed): multimodal embedding model specifications, verified 2026-06-25
- [Cohere Command A+ announcement](https://cohere.com/blog/command-a-plus): Apache 2.0 Command A+ release and model details, verified 2026-06-25
- [Cohere North Mini Code announcement](https://cohere.com/blog/north-mini-code): Apache 2.0 coding-model release and availability, verified 2026-06-25
- [Cohere Transcribe page](https://cohere.com/transcribe): 03-2026 enterprise speech-to-text model, verified 2026-06-25
- [Cohere pricing docs](https://docs.cohere.com/docs/how-does-cohere-pricing-work): token counting and billing mechanics, verified 2026-06-25
- [Cohere and Aleph Alpha announcement](https://cohere.com/blog/cohere-alephalpha-join-forces): planned sovereign-AI combination, verified 2026-06-25

## Related

- **Category:** [AI Chatbots](/categories/ai-chatbots/) · [AI Search](/categories/ai-search/)
- **Alternatives:** [Claude](/tools/claude/) · [ChatGPT](/tools/chatgpt/) · [Gemini](/tools/gemini/) · [Llama](/tools/llama/) · [Mistral AI](/tools/mistral-ai/) · [DeepSeek](/tools/deepseek/)
