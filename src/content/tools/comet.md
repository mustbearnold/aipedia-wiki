...
facts:
  ...
  best_for:
    ...
    confidence: high
  best_paid_tier:
    value: "Perplexity paid tiers when higher AI capacity or advanced model access matters"
...
quick_answer: >-
  Perplexity Comet is Perplexity's AI browser for cited search, page-aware assistance, and delegated web tasks. Pick it when you want research, browsing, summarization, and assistant actions in one browser. Skip it if you need mature enterprise browser controls or programmable browser infrastructure.
---
...
As verified on 2026-06-12, Comet is promoted for Mac, Windows, iOS, and Android. That matters because it is no longer just an experimental desktop browser for Perplexity power users; it is trying to become a daily browser surface.
...
| Companion product | Personal Computer for Mac (Perplexity Max, $200/mo) for Mac users who want a persistent local agent alongside Comet |
