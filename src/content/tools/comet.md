...
tagline: Perplexity's AI browser, combining answer-engine search with page context and agentic browsing.
category: ai-search
...
meta_description: "Updated June 26, 2026: Perplexity Comet is a free AI browser for Mac, Windows, iOS, and Android, with paid Perplexity tiers adding Comet Agent, Max Assistant, Computer credits, and enterprise controls."
...
facts:
  web_browsing:
    value: "AI browser with Perplexity search built in"
  ...
  best_for:
    ...
    confidence: high
  best_paid_tier:
    value: "Use the free browser first; upgrade Perplexity only when Comet Agent query limits, Max Assistant, Computer credits, advanced models, or enterprise browser controls matter"
...
price_history:
  ...
  - date: 2026-04-16
    ...
    price: "Personal Computer for Mac launched"
  ...
  - date: 2026-05-13
    plan: "Comet"
    price: "Free browser; paid Perplexity tiers can lift AI capacity"
    source: "https://www.perplexity.ai/comet"
    source_label: "Perplexity Comet"
    source_id: perplexity-comet
...
best_for:
  ...
  - users who already trust Perplexity's cited answers
  - workflows involving source discovery and page summarization
  - people who want an assistant browser for email, shopping, planning, and web tasks
not_best_for:
  - teams standardized on Chrome or Edge management
  - users who dislike answer-engine mediation
  - browser automation developers
quick_answer: >-
  Perplexity Comet is Perplexity's AI browser for cited search, page-aware assistance, and delegated web tasks. Pick it when you want research, browsing, summarization, and assistant actions in one browser. Use the free browser first; pay only when Comet Agent, Max Assistant, Computer credits, or higher Perplexity capacity become the bottleneck. Skip it if you need mature enterprise browser controls or programmable browser infrastructure.
---
...
- [Perplexity Comet](https://www.perplexity.ai/comet): platform availability and browser-assistant task examples
- [Perplexity Enterprise Comet](https://www.perplexity.ai/enterprise/comet): enterprise browser controls, domain blocks, approval rules, and agent task limits
- [Perplexity Enterprise pricing](https://www.perplexity.ai/enterprise/pricing): Comet Assistant, Comet Agent query limits, Computer credits, Enterprise controls, and paid plan context
- [Perplexity Max help](https://www.perplexity.ai/help-center/en/articles/11680686-perplexity-max): Max Assistant on Comet and individual Max pricing
- [Perplexity API privacy and security](https://docs.perplexity.ai/docs/resources/privacy-security): Sonar API retention and security certification context
