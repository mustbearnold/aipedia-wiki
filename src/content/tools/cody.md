...
facts:
  ...
  ai_terms:
    ...
    confidence: high
  marketplace_status:
    value: "The VS Code Marketplace still lists Cody as a free Sourcegraph extension with 852,345 installs, but its overview says Cody is no longer available for non-enterprise users and still contains stale Cody Pro/model-option wording."
    source: "https://marketplace.visualstudio.com/items?itemName=sourcegraph.cody-ai"
    source_label: "Cody VS Code Marketplace listing"
    source_id: cody-vscode-marketplace
    verified_at: 2026-06-15
...
Every data point above was verified against vendor sources on 2026-06-15. See Sources.
...
- [Sourcegraph pricing](https://sourcegraph.com/pricing): current Enterprise plan starting price and AI-credit packaging, verified 2026-06-15.
- [Changes to Cody Free, Pro, and Enterprise Starter plans](https://sourcegraph.com/blog/changes-to-cody-free-pro-and-enterprise-starter-plans): July 23, 2025 retirement announcement, verified 2026-06-15.
- [Sourcegraph Cody docs](https://sourcegraph.com/docs/cody): supported surfaces and Cody feature scope, verified 2026-06-15.
- [Sourcegraph Model Provider docs](https://sourcegraph.com/docs/model-provider): Cody Gateway, model-provider access, rate limits, privacy, and security, verified 2026-06-15.
- [Sourcegraph AI Terms](https://sourcegraph.com/terms/ai-terms): Enterprise AI ownership, retention, data-use, indemnification, and output-review terms, verified 2026-06-15.
- [Cody VS Code Marketplace listing](https://marketplace.visualstudio.com/items?itemName=sourcegraph.cody-ai): public extension status, 852,345 installs, stale Cody Pro copy, and non-enterprise availability warning, verified 2026-06-15.
- [Sourcegraph model configuration docs](https://sourcegraph.com/docs/cody/enterprise/model-configuration): Enterprise model filters and provider/model overrides, verified 2026-06-15.
