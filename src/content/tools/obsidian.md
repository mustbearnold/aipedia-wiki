...
Obsidian is free for personal use with no feature restrictions, offering optional paid add-ons including Sync at $4 per month for end-to-end encrypted cross-device sync and Publish at $8 per month, plus a $50 per year commercial license for business use ([Obsidian Pricing](https://obsidian.md/pricing)).

| Plan | Price | Key Limits |
|------|-------|-----------|
| Personal | $0 | Full app, unlimited notes, all community plugins |
| Sync | $4/mo ($48/yr) | End-to-end encrypted sync across devices, 10GB storage |
