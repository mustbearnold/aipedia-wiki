...
slug: runway
title: Runway
tagline: Production AI video workspace with Runway Agent, Gen-4.5, Gen-4 Turbo, Aleph 2.0/Edit Studio, Act-Two performance capture, third-party video models, and a developer API.
category: ai-video
...
facts:
  flagship_model:
    value: "Gen-4.5 for text-to-video, Gen-4 Turbo for fast image-to-video, and Aleph 2.0 in Edit Studio for controlled video editing"
  ...
  best_paid_tier:
    ...
    next_review_at: 2026-07-08
  api_available:
    value: "Yes - Runway API exposes video models including seedance2, seedance2_fast, aleph2, gen4.5, gen4_turbo, act_two, veo3, veo3.1, and veo3.1_fast. Gen-4 Aleph is deprecated and scheduled to sunset on July 30, 2026."
  ...
  image_generation:
    ...
    next_review_at: 2026-07-08
  video_generation:
    value: "Gen-4.5, Gen-4 Turbo, Aleph 2.0, Act-Two, Veo 3.1/Veo 3, Kling 3.0, Nano Banana Pro, Seedance 2.0 through selected plan/API routes, and more depending on plan, region, and model availability"
    source: "https://runwayml.com/pricing"
    source_label: "Runway pricing"
    source_id: runway-pricing
    verified_at: 2026-06-24
  ...
  web_browsing:
    ...
    confidence: high
  coding_agent:
    value: "No coding agent; Runway's developer product is an API for generative media, not a software-development agent"
    source: "https://docs.dev.runwayml.com/"
    source_label: "Runway API docs"
    source_id: runway-api-docs
    verified_at: 2026-06-24
    ...
    confidence: high
  enterprise_controls:
    value: "Enterprise offers SSO, configurable teams/spaces, advanced security, custom credits, workspace analytics, and enterprise support"
    source: "https://runwayml.com/pricing"
    source_label: "Runway pricing"
    source_id: runway-pricing
    verified_at: 2026-06-24
  ...
  open_source_or_local:
    ...
    confidence: high
  best_for:
    value: "Production AI video workflow, model switching, video editing, character performance capture, team workspaces, and API pipelines"
    source: "https://runwayml.com/pricing"
    source_label: "Runway pricing"
    source_id: runway-pricing
    verified_at: 2026-06-24
    ...
    confidence: high
  watch_out_for:
    value: "Runway is not automatically the best raw model per dollar; credit/API costs add up, Gen-4 Aleph is deprecated in favor of Aleph 2.0, and third-party model behavior may differ from Runway-owned models"
...
meta_description: "Runway is the best production AI video workspace, not always the raw model winner. Updated June 24, 2026 with Max plan pricing, Studio Trim, Gen-4.5, Aleph 2.0, Act-Two, Veo 3.1, Kling 3.0, Seedance API access, pricing, and API guidance."
author: "aipedia.wiki Editorial"
best_for:
  - video production teams
  - agencies and creators shipping finished video
  - multi-model AI video testing
  - aleph video editing
  - act-two character performance capture
  - api integration
not_best_for:
  - cheapest raw model-quality testing
  - buyers who only need one frontier model
...
price_history:
  - date: 2026-06-24
    plan: "Runway pricing, Studio Trim, and API model recheck"
    price: "Free; Standard $12/user/mo billed annually; Pro $28/user/mo; Max $76/user/mo; API credits $0.01/credit"
    source: "https://runwayml.com/pricing"
    source_label: "Runway pricing"
    source_id: runway-pricing
    verified_at: 2026-06-24
    note: "Rechecked public plan pricing, Studio Trim, current pricing examples, API model IDs, and API pricing. Runway API now lists aleph2 and deprecates gen4_aleph for July 30, 2026."
  - date: 2026-06-05
    plan: "Runway pricing and API recheck"
    price: "Free; Standard $12/user/mo billed annually; Pro $28/user/mo; Max $76/user/mo; API credits $0.01/credit"
    source: "https://runwayml.com/pricing"
    source_label: "Runway pricing"
    source_id: runway-pricing
  ...
  - date: 2026-05-08
    ...
    price: "$76/user/mo billed annually"
    source: "https://runwayml.com/pricing"
    source_label: "Runway pricing"
    source_id: runway-pricing
    verified_at: 2026-06-12
...
Runway is a production AI video workspace and API platform. Its value is not just one model. As of June 24, 2026, Runway gives creators and teams a single workspace for Gen-4.5 text-to-video, Gen-4 image tools, Gen-4 Turbo iteration, Aleph 2.0 video editing, Act-Two performance capture, Studio Trim, Veo 3.1/Veo 3, and third-party video models such as Kling 3.0 and selected Seedance routes.
...
- **June 24, 2026:** Rechecked Runway pricing, changelog, API models, and API pricing. Public pricing still lists Free, Standard $12/user/month billed annually, Pro $28/user/month, Max $76/user/month, and Enterprise custom. The API model list now uses `aleph2`, marks `gen4_aleph` deprecated for July 30, 2026, and still lists `seedance2`, `seedance2_fast`, `gen4.5`, `gen4_turbo`, `act_two`, `veo3`, `veo3.1`, and `veo3.1_fast`.
- **June 18, 2026:** Runway added Studio Trim, a workspace feature for trimming, stitching, reordering, and exporting a final video in one place.
...
| **Primary proprietary models** | Gen-4.5, Gen-4, Gen-4 Turbo, Aleph 2.0 / Gen-4 Aleph, Act-Two |
| **Third-party model access** | Runway pricing and changelog list Veo 3.1, Veo 3, Kling 3.0, Nano Banana Pro, Seedance 2.0 routes, Sora 2 Pro, and more, depending on plan, region, and surface |
| **Free tier** | 125 one-time credits, Gen-4 Turbo image-to-video, 3 editor projects, 5GB storage, no Gen-4 Video |
| **First serious paid tier** | Standard at $12/user/month billed annually, 625 monthly credits |
| **API** | Yes; API model list includes seedance2, seedance2_fast, aleph2, gen4.5, gen4_turbo, act_two, veo3, veo3.1, and veo3.1_fast |
| **API credit anchor** | $0.01 per credit; video model costs vary by credits per second |
| **Commercial rights** | Runway says users retain rights to uploaded and generated content, including commercial use |
| **Enterprise controls** | SSO, custom credits, configurable organization/team spaces, advanced security, workspace analytics, and priority support |
| **Main watch-out** | Credit/API costs can rise quickly; Gen-4 Aleph is deprecated in favor of Aleph 2.0; third-party model access and behavior may change |

## What Runway Actually Is

Runway is a browser-based creative production suite with a developer API. The pricing page now matters more than a single model-release page because it shows the buyer route: Free for exploration, Standard for real creative access, Pro for heavier use, Max for the largest public monthly credit allowance, and Enterprise for security/procurement.

The most important strategic point: Runway is a consolidation layer. A creator can use Runway's own models and selected third-party models without maintaining separate accounts for every frontier model provider. That is a conversion advantage for AiPedia: many users want the shortest path from model choice to finished video.
...
- **Best raw model test:** [Seedance 2.0](/tools/seedance/). Test it first when motion realism, multimodal reference, audio-video generation, and director-style control are the core question.
- **Best cinematic/value challenger:** [Kling 3.0](/tools/kling/). Test it beside Seedance for cinematic creator work, native audio, and multi-shot video.
- **Best Google/API route:** [Veo 3.1](/tools/veo/). Choose it when Gemini API, Vertex AI, Google procurement, SynthID provenance, or Google Cloud governance are requirements.
- **Budget/effects:** [Pika](/tools/pika/). Useful for lighter social clips and quick creative effects.
- **Avatar video:** [HeyGen](/tools/heygen/) or [Synthesia](/tools/synthesia/). Use avatar tools for presenter-led sales/training/localization clips, not cinematic scene generation.
...
**Standard:** $12/user/month billed annually, 625 monthly credits, and access to Gen-4.5, Gen-4 image tools, Aleph 2.0, Act-Two, Veo 3.1/Veo 3, video apps, and selected third-party models. Best for the first serious creator purchase.
...
**Max:** $76/user/month billed annually, 9,500 monthly credits, unused credits rolling over for one month, first access to newest models, and highest generation volume. Best for high-volume creative iteration.
...
**Credit reality:** Runway's API pricing page lists credits at $0.01 each. Current video API examples include `gen4.5` at 12 credits/second, `gen4_turbo` at 5 credits/second, `aleph2` at 28 credits/second with a 56-credit minimum, `act_two` at 5 credits/second, `veo3` at 40 credits/second, and `veo3.1` audio at 40 credits/second. The old `gen4_aleph` route is deprecated and scheduled to sunset on July 30, 2026.
...
- `seedance2` and `seedance2_fast` for text, image, or video to video
- `aleph2` for video plus text or image to video
...
For API-heavy products, compare Runway's $0.01/credit economics against direct Veo 3.1 Gemini API pricing and any official route you can get for Seedance or Kling. Runway may win on integration convenience even when another provider wins on raw model cost.
...
Standard is the first serious paid tier for most creators because it unlocks the core production models and workflows. Pro is for more credits/storage and custom voices. Max is for high-volume credit-backed work.

**Does Runway include Seedance, Kling, and Veo?**
Runway's current pricing and changelog list Veo 3.1/Veo 3, Kling 3.0, Seedance 2.0 routes, Sora 2 Pro, Nano Banana Pro, and more. Verify availability in your account before buying for one exact model because plan, region, and surface can differ.

**Does Runway have an API?**
Yes. The API docs list video models including seedance2, seedance2_fast, aleph2, gen4.5, gen4_turbo, act_two, veo3, veo3.1, and veo3.1_fast.

**Can I use Runway outputs commercially?**
Runway's usage-rights help page says users retain rights to uploaded and generated content and can use generated content commercially without non-commercial restrictions from Runway.

**Is Runway better than Veo 3.1?**
For Google-stack API and provenance use cases, Veo 3.1 may be the cleaner model route. For a broad creative production workspace with editing and team workflows, Runway is usually the stronger product.

## Sources

- [Runway pricing](https://runwayml.com/pricing) (verified 2026-06-24)
- [Runway changelog](https://runwayml.com/changelog) (verified 2026-06-24)
...
- [Available Models on Runway](https://help.runwayml.com/hc/en-us/articles/48649877897107-Available-Models-on-Runway) (verified 2026-06-24)
- [Runway API docs](https://docs.dev.runwayml.com/)
- [Runway API models](https://docs.dev.runwayml.com/guides/models/) (verified 2026-06-24)
- [Runway API pricing](https://docs.dev.runwayml.com/guides/pricing/) (verified 2026-06-24)
