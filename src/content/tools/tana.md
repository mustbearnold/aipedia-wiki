...
slug: tana
title: Tana
tagline: An agentic meeting platform where AI agents join your calls, transcribe them, and turn the discussion into documents, tasks, and a context graph during the meeting.
category: ai-notes
...
facts:
  best_for:
    value: "Teams who want work to happen during the meeting, not after: Tana's agents join Zoom, Teams, and Google Meet calls, transcribe in dozens of languages, and create documents, file issues, and update a shared context graph from what was said."
    source: "https://tana.inc"
    source_label: "Tana product site"
    source_id: tana-product
  ...
  watch_out_for:
    value: "Tana split into two products that share a brand name: the current Tana meeting platform at tana.inc and the older Tana Outliner knowledge tool at outliner.tana.inc. Pick the wrong one and the pricing, features, and workflow are different. The meeting platform is also young and priced on early-bird rates that will change."
    source: "https://tana.inc"
    source_label: "Tana"
    source_id: tana-product
    verified_at: 2026-06-16
    volatility: medium
    confidence: medium
tags: [ai-notes, meeting-notes, meeting-agent, ai-automation, knowledge-management, tana]
best_for:
  - in-meeting AI agents that act during the call
  - automatic meeting transcripts and summaries
  - turning discussion into docs, issues, and tasks
  - teams that live in Zoom, Teams, or Google Meet
not_best_for:
  - people who want a simple personal notes app
  - users who only want the original Supertags outliner
  - teams needing a mature all-in-one docs suite
  - offline-first or fully local note storage
quick_answer: >-
  Tana is now an agentic meeting platform. AI agents join your Zoom, Teams, or Google Meet calls, transcribe them, and turn the discussion into documents, tasks, and a shared context graph while the meeting is still happening. Pick it if you want work to start during meetings rather than after. Note that the original Tana Supertags outliner is now a separate product at outliner.tana.inc.
---
...
>
> **Skip it if you want a simple notes app or the old Supertags tool.** The meeting platform is built for teams and live calls, not quiet personal note-taking. If you came for the original outliner and its Supertags model, you want [Tana Outliner](https://outliner.tana.inc) or a tool like [Notion AI](/tools/notion-ai/) instead.
>
...
| **Company** | Tana |
| **Closest alternatives** | [Notion AI](/tools/notion-ai/), dedicated AI notetakers |
...
- **The original outliner:** use [Tana Outliner](https://outliner.tana.inc) for the Supertags knowledge tool.
- **All-in-one docs and wiki:** [Notion AI](/tools/notion-ai/) is more mature for general docs and team wikis.
