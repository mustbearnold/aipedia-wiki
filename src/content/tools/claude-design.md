...
slug: claude-design
title: Claude Design
tagline: Anthropic Labs prompt-to-prototype tool. Launched April 17, 2026 as a research preview for Claude Pro, Max, Team, and Enterprise users; reads codebases/design files, exports to Canva/PDF/PPTX/HTML/URL, and hands off to Claude Code.
category: ai-design
...
facts:
  ...
  pricing_anchor:
    value: Claude Design is included for Claude Pro, Max, Team, and Enterprise subscribers and uses subscription limits, with extra usage available; Claude Pro currently shows $17/mo with annual billing or $20 monthly.
  ...
  workflow_surface:
    ...
    next_review_at: '2026-08-13'
  watch_out_for:
    value: Because Claude Design is new and access can change quickly, avoid claiming it switched from the launch backing model to a newer Claude model unless Anthropic updates the Claude Design page or support docs.
    source: https://www.anthropic.com/news/claude-design-anthropic-labs
    source_label: Anthropic Claude Design launch page
    source_id: claude-design-official
    verified_at: '2026-06-02'
...
best_for:
  ...
  - founders making investor decks
  - developers mocking UI before coding
  - marketers generating campaign visuals
  - teams with existing design systems in code
not_best_for:
  - professional pixel-perfect design work
  - print production and CMYK workflows
...
decision_brief:
  items:
    ...
    - label: Included with
      value: "Claude Pro+"
      detail: "No separate subscription, but no free Claude tier access; uses subscription limits."
...
- **May 12, 2026:** [Anthropic launched Claude for Legal](/news/2026-05-12-anthropic-claude-for-legal-plugins-microsoft-365/) with 12 practice-area plugins and a Microsoft 365 integration. Reinforces that Anthropic is shipping verticalized Claude surfaces around the same paid Claude plan ecosystem that includes Claude Design.
...
>
> **Who it's free for:** existing Claude Pro, Max, Team, and Enterprise subscribers. No standalone pricing and no free Claude tier access. Pro currently lists $17/month with annual billing ($200 upfront) or $20 monthly; Claude Design uses subscription limits, with extra usage available.
...
| **Status** | Research preview (feature flag) |
...
| **Pricing** | Bundled in Claude Pro and up; Pro currently $17/mo annual or $20 monthly |
...
- **Professional product design work:** [Figma](/tools/figma/). Pixel-perfect editing, design systems at scale, real-time multiplayer, dev handoff via Dev Mode. Still the reference for product designers.
- **Pure prompt-to-code with no design step:** [Lovable](/tools/lovable/), [Bolt](/tools/bolt/), or [v0](/tools/v0/). Generate shipped code from prompts when visual fidelity is secondary.
- **Template-driven marketing design:** [Canva](/tools/canva/). Huge template library, brand kits, easier for non-technical teams without Claude Pro.
- **Presentation-specific work:** [Gamma](/tools/gamma/) or [Beautiful.ai](/tools/beautiful-ai/). More polish on slide-specific layouts and auto-design for presentations.
- **UI/UX wireframe ideation:** [Uizard](/tools/uizard/) or [Galileo AI](/tools/galileo-ai/). Purpose-built for screen flow and wireframe generation.
- **You don't pay for Claude:** all the above alternatives ship free tiers. Claude Design has no standalone free option.

## Pricing

Claude Design is **bundled with every paid Claude tier**. No separate subscription. Access uses your Claude subscription limits, with optional extra usage available.

| Claude tier | Monthly | Claude Design access |
|---|---|---|
| Free | $0 | Not available |
| Pro | $17/mo annual or $20 monthly | Access included, subject to subscription limits |
| Max 5x | From $100/mo | Access included + higher usage |
| Max 20x | Higher Max option | Access included + highest usage |
...
| | Claude Design | [Figma](/tools/figma/) + AI | [Lovable](/tools/lovable/) / [Bolt](/tools/bolt/) / [v0](/tools/v0/) | [Canva](/tools/canva/) |
|---|---|---|---|---|
...
No. It's bundled with every paid Claude tier: Pro ($20/mo), Max ($100 or $200/mo), Team ($30/user/mo), and Enterprise. No standalone pricing.
...
- [Anthropic: Claude Design announcement](https://www.anthropic.com/news/claude-design-anthropic-labs) (vendor blog)
- [Claude pricing](https://claude.com/pricing) (plans, Pro/Max pricing, included Claude product surfaces)
...
- **Category:** [AI Design](/categories/ai-design/) · [AI Coding](/categories/ai-coding/)
- **News:** [Claude Design launches](/news/2026-04-17-anthropic-launches-claude-design/)
- **Paired tool:** [Claude Code](/tools/claude-code/) (production build handoff)
- **Main Claude tool:** [Claude](/tools/claude/) (assistant + code + design bundled)
- **Competitors:** [Figma](/tools/figma/) · [Lovable](/tools/lovable/) · [Bolt](/tools/bolt/) · [v0](/tools/v0/) · [Canva](/tools/canva/) · [Gamma](/tools/gamma/) · [Uizard](/tools/uizard/)
