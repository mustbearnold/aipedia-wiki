...
facts:
  best_for:
    value: >-
      Best for Claude users turning prompts and design-system context into prototypes, design artifacts, and handoff material inside the Claude ecosystem.
  ...
  code_handoff:
    value: >-
      The strongest buyer story is prototype-to-build handoff inside the Claude/Claude Code ecosystem: /design-sync pulls an existing design system into Claude Design, and /design lets users create, edit, sync, import, or export design work from Claude Code.
  ...
  workflow_surface:
    value: >-
      Claude Design belongs in design prototyping and creative-production workflows, but production readiness still depends on export quality and engineering review.
    source: https://www.anthropic.com/news/claude-design-anthropic-labs
    source_label: Anthropic Claude Design launch page
    source_id: claude-design-official
    verified_at: '2026-06-25'
...
- **Claude Code handoff got more concrete.** The get-started guide now documents `/design-sync` for pulling in the design system and `/design` for creating, editing, syncing, importing, or exporting Design work from Claude Code.
- **The model caveat still stands.** Claude release notes list Opus 4.8 as a broader Claude upgrade, but the Claude Design launch and release-note language still tie Design to Opus 4.7. AiPedia is not claiming a Design-specific switch to Opus 4.8.
