...
facts:
  ...
  flagship_model:
    ...
    next_review_at: 2026-07-02
  figma_make_scope:
    value: "Figma Make creates functional prototypes, web apps, and interactive UI from prompts, attached Figma designs, style libraries, backend instructions, and verified partner MCP connectors on paid plans."
    source: "https://help.figma.com/hc/en-us/articles/35440096186007-Use-verified-partner-MCP-connectors-in-Figma-Make"
    source_label: "Figma Make MCP connectors"
    source_id: figma-make-mcp-connectors
    verified_at: 2026-06-23
    volatility: medium
    confidence: high
  code_handoff:
    value: "Figma Make supports pushing to GitHub repositories it creates, but the sync is one-way from Figma Make to GitHub and external edits can be overwritten."
    source: "https://help.figma.com/hc/en-us/articles/35463818346647-Push-from-Figma-Make-to-GitHub"
    source_label: "Figma Make GitHub push docs"
    source_id: figma-make-github
    verified_at: 2026-06-26
    volatility: medium
    confidence: high
  config_2026:
    value: "Figma's Config 2026 recap added Code Layers, Figma Motion, shader effects, generative plugins, Weave tools, agent skills, deeper context, web search, third-party connectors, and file attachments to the canvas and agent roadmap."
    source: "https://www.figma.com/blog/config-2026-recap/"
    source_label: "Figma Config 2026 recap"
    source_id: figma-config-2026-recap
    verified_at: 2026-06-26
    volatility: high
    confidence: high
...
meta_description: "Updated June 26, 2026: Figma pricing, Full seats, AI credits, Figma Make model selection, Sites, Dev Mode, best plan, alternatives, and buyer risks."
...
price_history:
  ...
  - date: 2026-05-08
    ...
    source_id: figma-pricing
    verified_at: 2026-06-26
    note: "Current public pricing page lists Starter free, Professional Full seat $16/mo, Organization Full seat $55/mo, Enterprise Full seat $90/mo, and optional AI credit add-ons."
  - date: 2026-05-13
    plan: "Professional Full seat"
    price: "$16/mo"
    source: "https://www.figma.com/pricing/"
...
- **June 26, 2026 verification:** Figma's current pricing page lists Starter free, Professional Full seat $16/month, Organization Full seat $55/month, Enterprise Full seat $90/month, separate Dev/Collab seat pricing, optional team AI-credit add-ons, Figma Sites beta on Full seats, and Figma Buzz beta across seats.
- **Config 2026 widened Figma's agent surface.** Figma's official recap adds Code Layers, Figma Motion, shader effects, generative plugins, Weave tools, agent skills, deeper context, web search, third-party connectors, and file attachments. This strengthens Figma's design-to-code story, but teams should still test code ownership and review workflows before treating it like a full application platform.
...
- **Figma Make is broader than a mockup generator:** Current docs describe prompt creation, attached designs, style-library context, backend instructions, paid-plan verified partner MCP connectors, preview editing, direct code editing, code ZIP download, and GitHub push.
...
| Code handoff | Download code ZIP or push to a Figma-created GitHub repo; outside code changes do not sync back and can be overwritten |
| Config 2026 additions | Code Layers, Motion, shaders, generative plugins, Weave tools, agent skills, web search, third-party connectors |
| Main watch-out | Seat costs plus AI-credit burn can outrun value if the buyer only needs one prompt-built app |

Every fact above was checked against official Figma sources on 2026-06-26. See Sources.
...
Figma Make is the part that overlaps most with app builders. It lets users describe a prototype or web app in chat, attach Figma designs, use style context from libraries, add backend instructions, use paid-plan verified partner MCP connectors, inspect an interactive preview, and edit code directly. Its advanced docs describe Supabase for multi-user app support and code handoff options including ZIP download and GitHub push.

The important limitation is ownership flow. Code can leave Figma Make, but the GitHub push docs say Make pushes to repositories it creates and that the sync is one-way from Figma Make to GitHub. Changes made in GitHub or a local IDE do not appear back in Make and can be overwritten by the next push.
...
- **Pick [Claude Design](/tools/claude-design/) for prompt-to-prototype work.** Bundled with Claude Pro and higher tiers, it produces slide decks, app mockups, and pitch materials from prompts, reads codebases to extract the design system, and exports to PDF, PPTX, URL, or Canva before handing off to Claude Code.
...
Pricing was checked against [Figma pricing](https://www.figma.com/pricing/) on 2026-06-26. Figma's current public page is seat based, not a flat "AI design app" subscription.
...
Figma also now sells AI credits as an add-on. The pricing page says teams can enable pay-as-you-go for flexibility or subscribe to save, while the AI Credit Terms say included seat credits are consumed before subscription credits and pay-as-you-go charges.
...
- **Figma Make is not a complete production pipeline.** Downloading ZIP code or pushing to GitHub helps, but the GitHub route is one-way and limited to Figma-created repositories.
...
This page was updated on 2026-06-26 against official Figma pricing, AI credit, Make model, Make GitHub push, and plans/features documentation. MCP connector, advanced Make, and billing-guide facts remain from the prior June 23 check.
...
Figma Make can create functional prototypes, web apps, and interactive UI from prompts. Current docs also describe backend instructions, Supabase-backed multi-user examples, editable code, ZIP download, and GitHub push to Figma-created repositories.

**What models does Figma Make use?**

As verified on June 26, 2026, Figma's model-selection docs list multiple selectable non-default models and say the default model may change over time.
...
- [Figma pricing](https://www.figma.com/pricing/) - current plan, seat, AI-credit, Make, Sites, and feature matrix. Verified 2026-06-26.
- [Figma Config 2026 recap](https://www.figma.com/blog/config-2026-recap/) - Code Layers, Motion, shaders, generative plugins, Weave tools, agent skills, web search, third-party connectors, and file attachments. Verified 2026-06-26.
- [Figma AI credits](https://help.figma.com/hc/en-us/articles/33459875669015-How-AI-credits-work) - credit allowances, monthly reset, non-rollover rules, daily caps, and model/complexity consumption notes. Verified 2026-06-26.
- [Figma AI Credit Terms](https://www.figma.com/legal/ai-credit-terms/) - subscription credit, pay-as-you-go, and credit-consumption order terms. Verified 2026-06-23.
- [Figma Make model selection](https://help.figma.com/hc/en-us/articles/36400680326551-Select-an-AI-model-to-use-in-Figma-Make) - selectable models and default-model caveat. Verified 2026-06-26.
- [Create and edit a Figma Make file](https://help.figma.com/hc/en-us/articles/31304485164695-Create-and-edit-a-Figma-Make-file) - prompt workflow, attached designs, backend instructions, MCP connectors, preview, and code editing. Verified 2026-06-23.
- [Beyond the basics: Using Figma Make](https://help.figma.com/hc/en-us/articles/35710574222487-Beyond-the-basics-Using-Figma-Make) - Supabase support, code ZIP download, and GitHub push. Verified 2026-06-23.
- [Push from Figma Make to GitHub](https://help.figma.com/hc/en-us/articles/35463818346647-Push-from-Figma-Make-to-GitHub) - Figma-created repository, one-way sync, default branch, and overwrite limitations. Verified 2026-06-26.
- [Use verified partner MCP connectors in Figma Make](https://help.figma.com/hc/en-us/articles/35440096186007-Use-verified-partner-MCP-connectors-in-Figma-Make) - paid-plan MCP connector availability and context behavior. Verified 2026-06-23.
- [Figma plans and features](https://help.figma.com/hc/en-us/articles/360040328273-Figma-plans-and-features) - product lineup, plan features, and governance features. Verified 2026-06-26.
- [Figma billing guide](https://help.figma.com/hc/en-us/articles/29717597009431-Guide-to-billing-at-Figma) - seat types and product access by role. Verified 2026-06-23.
