...
slug: rork
title: Rork
tagline: AI mobile app builder for browser-based iOS and Android creation. React Native/Expo apps by default, Swift-only Rork Max for premium iOS, free tier plus plans from $25 to $1,800/month.
category: ai-design
...
seo_title: "Rork: Features, Pricing & Review (April 2026)"
meta_description: "Rork builds and publishes mobile apps from prompts. Free includes 35 credits/month; Junior is $25/mo, Middle $50/mo, Senior $100/mo, and Scale plans run up to $1,800/mo."
...
best_for:
  ...
  - creators who need phone testing without local mobile tooling
  - teams that want React Native/Expo output from prompts
  - iOS-focused apps that may justify Rork Max
not_best_for:
...
- **Web app with managed backend:** [Base44](/tools/base44/) or [Lovable](/tools/lovable/).
- **Browser IDE and hosted app agent:** [Replit Agent](/tools/replit-agent/).
- **Frontend prototyping:** [Bolt.new](/tools/bolt/) or [v0](/tools/v0/).
- **Professional mobile engineering:** a React Native, Expo, or Swift developer using [Cursor](/tools/cursor/) or [Claude Code](/tools/claude-code/).
- **Enterprise-grade app platform:** traditional mobile development plus CI/CD and security review.

## Pricing

Pricing via [Rork subscription docs](https://docs.rork.com/introduction/subscriptions):
...
This page was produced by the aipedia.wiki editorial pipeline. Scoring follows the four-dimension rubric at [/about/scoring/](/about/scoring/) (Utility x Value x Moat x Longevity, unweighted average). Last verified 2026-04-28 against Rork primary documentation.
...
- [Rork welcome docs](https://docs.rork.com/): product description and browser-based app-building workflow
- [Rork subscription docs](https://docs.rork.com/introduction/subscriptions): plan prices, credits, reset policy
- [Rork technical FAQ](https://docs.rork.com/faq/technical): React Native, Expo, Rork Max, platform support
- [Rork first app guide](https://docs.rork.com/introduction/build-your-first-app): simulator and phone testing flow

## Related

- **Category:** [AI Design](/categories/ai-design/) · [AI Coding](/categories/ai-coding/)
- **Alternatives:** [Base44](/tools/base44/) · [Lovable](/tools/lovable/) · [Replit Agent](/tools/replit-agent/) · [Bolt.new](/tools/bolt/) · [v0](/tools/v0/)
