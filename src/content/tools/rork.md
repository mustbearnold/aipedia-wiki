...
- [Rork GitHub sync guide](https://docs.rork.com/tutorials/how-to-connect-github): two-way sync, developer handoff, Cursor/Xcode workflows
- [Rork API guide](https://docs.rork.com/features-apis/apis/how-to-connect-an-api-to-your-project): environment variables, Supabase edge-function pattern, API troubleshooting
- [Rork App Store checklist](https://docs.rork.com/submitting-to-app-store/apple/app-store-checklist): review prep, policies, paywall transparency, screenshots, support URL
