...
| Tool | Best For | Price |
|------|----------|-------|
| [Obsidian](../tools/obsidian.md) | Plain-text portability, deep plugin ecosystem | Free (core) |
| [NotebookLM](../tools/notebooklm.md) | AI-first research with source grounding | Free |
| [Notion AI](../tools/notion-ai.md) | Team collaboration + AI in a flexible workspace | Free tier / $10+/mo |
| Roam Research | Hardcore networked thought, daily notes focus | $15/mo |

## FAQ

**Is Capacities free?**
Yes. The free plan includes unlimited notes, all core object types, and cross-platform sync. AI features (writing assistant, AI chat over notes) require the Pro plan at €9/month. The free plan is usable indefinitely — it is not a trial.
...
Yes. The desktop and mobile apps support offline use with sync resuming when connectivity is restored.

## Sources

- [Capacities pricing page](https://capacities.io/pricing) (verified 2026-04-14)
- [Capacities changelog](https://capacities.io/changelog)
