...
slug: browserbase
title: Browserbase
tagline: Cloud browser infrastructure for agents, scraping, QA automation, and web data workflows that need managed Chromium, Fetch, Search, identity, runtime, and observability.
...
facts:
  ...
  platform_shift:
    ...
    confidence: high
  stagehand_update:
    value: "Stagehand 3.4 added ignoreSelectors for extract and observe, agent variables without the experimental requirement, hybrid default agent mode for compatible models, better OOPIF frame handling, and new computer-use model support."
...
- **May 13:** Stagehand 3.4.0 adds `ignoreSelectors`, hybrid default agent mode for compatible models, better OOPIF frame handling, and new CUA model support.
- **April 5:** Model Gateway opens multi-provider model access through a single Browserbase API key.
...
- [Browserbase API chooser](https://www.browserbase.com/blog/search-vs-fetch-vs-browsers)
- [Browserbase Functions announcement](https://www.browserbase.com/blog/browserbase-functions)
- [Browserbase Search announcement](https://www.browserbase.com/blog/search)
- [Browserbase Fetch announcement](https://www.browserbase.com/blog/fetch-api)
