...
facts:
  ...
  pricing_anchor:
    value: "Hardware billed by the second. CPU at $0.09/hr ($0.36/hr standard), T4 at $0.81/hr, L40S at $3.51/hr ($7.02 for 2x), A100 80GB at $5.04/hr ($10.08 for 2x), H100 at $5.49/hr ($10.98 for 2x). Output-priced examples include FLUX 1.1 Pro at $0.04 per image and Claude 3.7 Sonnet at $3 per million input tokens. Private deployments bill setup, idle, and active time."
...
seo_title: "Replicate Review: AI Model API, Official Models & Pricing (May 2026)"
...
As verified on 2026-05-13, Replicate's hardware rates run from CPU at $0.09/hr (small) or $0.36/hr (standard), through T4 at $0.81/hr, L40S at $3.51/hr (2x at $7.02), A100 80GB at $5.04/hr (2x at $10.08), and H100 at $5.49/hr (2x at $10.98). 4x and 8x GPU configurations require committed-spend contracts. Output-priced examples include FLUX 1.1 Pro at $0.04 per image, Claude 3.7 Sonnet at $3 per million input tokens, and Deepseek R1 at $3.75 per million input tokens. Enterprise and volume-discount conversations can add higher GPU limits, performance SLAs, priority support, onboarding help, and custom-model optimization.
...
Last verified 2026-05-13 against Replicate's official model and pricing documentation. Scoring emphasizes model breadth, developer experience, production stability, and cost predictability.
