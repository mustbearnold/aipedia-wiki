...
facts:
  ...
  api_available:
    value: AssemblyAI is API-first, with current docs covering pre-recorded STT, real-time STT, Voice Agent API, Speech Understanding, Guardrails, LLM Gateway, API reference pages, integrations, and AI coding-agent setup.
  ...
  voice_agent_api:
    value: AssemblyAI's Voice Agent API is positioned as a single WebSocket speech-to-speech stack that covers STT, LLM reasoning, TTS, tool calling, logs, and observability at $4.50/hr.
    ...
    next_review_at: '2026-07-18'
  llm_gateway_regions:
    value: AssemblyAI's LLM Gateway docs list US and EU endpoints, 25+ supported models, automatic retries and fallbacks, transcript injection, LLM Gateway on streaming turns, post-processing, tool/function calling, and a paid-account rate limit of 30 requests/minute per model.
    ...
    next_review_at: '2026-07-18'
  watch_out_for:
    value: Costs can move with audio volume, selected model, add-ons, multichannel files, and streaming connection duration; billing docs warn that unclosed streaming sessions can bill until automatic close after 3 hours.
...
best_for:
  ...
  - apps needing speaker diarization and audio understanding
  - real-time streaming transcription
  - teams comparing speech accuracy on messy audio
not_best_for:
  - casual meeting notes
  - podcast editing workflows
  - teams that only need one-off transcription uploads
quick_answer: >-
...
>
> **Skip it for end-user productivity.** If the job is "join my meetings and summarize them," use [Fathom](/tools/fathom/), [Fireflies](/tools/fireflies/), [Otter.ai](/tools/otter-ai/), or [Read AI](/tools/read-ai/).
>
...
- **Voice agents with bundled TTS:** [Deepgram](/tools/deepgram/) may be cleaner for full live voice stacks.
- **Meeting assistant:** [Fathom](/tools/fathom/), [Fireflies](/tools/fireflies/), [Read AI](/tools/read-ai/), [Tactiq](/tools/tactiq/).
- **Editing:** [Descript](/tools/descript/).
- **Local open transcription:** [Whisper](/tools/whisper/).
...
**Does AssemblyAI support streaming speech-to-text?**
...
Both are strong speech APIs. Deepgram leans hard into real-time voice agents and TTS. AssemblyAI leans into transcription quality and speech understanding.

## Sources

- [AssemblyAI pricing](https://www.assemblyai.com/pricing/)
- [AssemblyAI docs index](https://www.assemblyai.com/docs/llms.txt)
- [AssemblyAI models docs](https://www.assemblyai.com/docs/getting-started/models)
- [AssemblyAI Universal 3.5 Pro preview docs](https://www.assemblyai.com/docs/pre-recorded-audio/universal-3-5-pro)
- [AssemblyAI billing and pricing docs](https://www.assemblyai.com/docs/billing-and-pricing)
- [AssemblyAI LLM Gateway docs](https://www.assemblyai.com/docs/llm-gateway/overview)
- [AssemblyAI Voice Agent API](https://www.assemblyai.com/products/voice-agent-api)
- [AssemblyAI Voice Agent API guide](https://www.assemblyai.com/blog/voice-agent-api-vs-universal-3-pro-streaming)
...
- [AssemblyAI data retention and model training](https://www.assemblyai.com/docs/data-retention-and-model-training)
- [AssemblyAI changelog](https://www.assemblyai.com/changelog)

## Related

- **Category:** [AI Voice](/categories/ai-voice/)
- **See also:** [Deepgram](/tools/deepgram/) · [Whisper](/tools/whisper/) · [ElevenLabs](/tools/elevenlabs/) · [Fathom](/tools/fathom/) · [Read AI](/tools/read-ai/)
