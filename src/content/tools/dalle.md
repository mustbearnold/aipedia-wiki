...
slug: dalle
title: DALL-E
tagline: OpenAI's older image generation model family. DALL-E 2 and DALL-E 3 were removed from the API on May 12, 2026. Use GPT Image instead.
category: ai-image
company: OpenAI
...
facts:
  status:
    value: "DALL-E 2 and DALL-E 3 were removed from the OpenAI image API on May 12, 2026. Treat DALL-E as discontinued for new work; use current GPT Image models."
...
meta_description: "DALL-E 2 and DALL-E 3 were removed from the OpenAI API on May 12, 2026. New builds should use current GPT Image models."
author: "aipedia.wiki Editorial"
quick_answer: >-
  DALL-E is OpenAI's older image model family. DALL-E 2 and DALL-E 3 were removed from the API on May 12, 2026. Treat DALL-E as discontinued for new work and use current GPT Image models instead.
---
...
>
> **Do not start new API work on `dall-e-2` or `dall-e-3`.** They were removed from the API on May 12, 2026, so any remaining references are migration or compatibility cleanup, not a live integration path.
>
...
- Any code still referencing the `dall-e-3` model string will fail against the live API and needs migration.
- Current pricing should be read from OpenAI's pricing page because GPT Image costs depend on image tokens, quality, size, and input images. OpenAI's public API pricing page now lists GPT-Image-2 as the current image-generation billing anchor.
