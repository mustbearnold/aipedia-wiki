...
tagline: AWS-native AI coding assistant for existing Q Developer customers, with IDE plugins transitioning to Kiro by April 30, 2027.
category: ai-coding
...
facts:
  best_for:
    value: Best for existing AWS-heavy engineering teams already using Q Developer, while new IDE/plugin buyers should evaluate Kiro because AWS announced Q Developer IDE plugins and paid subscriptions will reach end of support on April 30, 2027.
  ...
  pricing_anchor:
    value: 'Amazon Q Developer has a perpetual Free tier for existing eligible access with 50 agentic chat interactions/mo and 1,000 LOC transformation/mo. Pro is $19/user/mo with roughly 1,000 user inputs for agentic requests, 4,000 LOC transformation per user per month pooled at account level, admin controls, and IP indemnity.'
  ...
  coding_agent:
    value: Amazon Q Developer is a coding and software-development assistant with AWS-specific features, but AWS says the IDE/plugin and paid-subscription lane is transitioning to Kiro.
  ...
  enterprise_controls:
    ...
    next_review_at: '2026-11-13'
  watch_out_for:
    value: Amazon Q Developer is not a greenfield default after AWS blocked new Q Developer signups/subscriptions on May 15, 2026 and moved the IDE/CLI future to Kiro; existing customers should plan migration before April 30, 2027.
...
meta_description: "Amazon Q Developer is AWS's AI coding assistant for existing customers, but IDE plugins and paid subscriptions reach end of support April 30, 2027. Pricing remains Pro $19/user/mo; new buyers should evaluate Kiro."
...
price_history:
  ...
  - date: 2026-05-13
    ...
    source_label: "Amazon Q Developer pricing"
    source_id: amazon-q-pricing
    note: "May verification snapshot. Free tier confirmed at 50 agentic chat interactions/mo plus 1,000 LOC transformation/mo. Pro 4,000 LOC transformation per user is pooled at the account level."
  - date: 2026-06-01
    plan: "Pro"
    price: "$19/user/mo"
    source: "https://aws.amazon.com/q/developer/pricing/"
    source_label: "Amazon Q Developer pricing"
    source_id: amazon-q-pricing
    note: "Re-verified June 1, 2026. Pricing unchanged. Free tier remains 50 agentic chat interactions/mo plus 1,000 LOC transformation/mo; Pro keeps pooled 4,000 LOC/user/mo transformation allocation and $0.003/LOC overage."
  - date: 2026-06-18
    plan: "Transition"
    ...
    source_label: "Amazon Q Developer end-of-support announcement"
    source_id: amazon-q-end-of-support
    note: "AWS says Q Developer IDE plugins and paid subscriptions reach end of support on April 30, 2027; new Q Developer Free Tier account creation and new subscription creation were blocked starting May 15, 2026; existing subscriptions can add users."
---
...
>
> **Skip it for greenfield editor procurement.** AWS is moving the IDE/CLI future to Kiro. [GitHub Copilot](/tools/github-copilot/) remains stronger for general coding across languages, frameworks, and non-AWS infrastructure. [Cursor](/tools/cursor/) still leads on multi-file autonomous edits.
>
...
- **General-purpose coding outside AWS:** [GitHub Copilot](/tools/github-copilot/). Broader language and framework coverage.
...
For casual exploration, yes. For daily work, no. 50 agentic chat interactions per month is one or two days of real development; the 1,000 LOC monthly transformation budget barely covers a small library migration.

**Is Amazon Q Developer still a good new purchase?**
...
- [AWS General Reference quotas](https://docs.aws.amazon.com/general/latest/gr/amazonqdev.html): Pro IDE/CLI, console, and CodeCatalyst quotas
- [Amazon Q Developer service improvement](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/service-improvement.html): Free-tier and Pro content-use posture
- [Amazon Q Developer end-of-support announcement](https://aws.amazon.com/blogs/devops/amazon-q-developer-end-of-support-announcement/): Kiro migration, new-signup cutoff, and April 30, 2027 support date
