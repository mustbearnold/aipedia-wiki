...
[Cursor](../tools/cursor.md) and [GitHub Copilot](../tools/github-copilot.md) are the most important AI coding choices for many developers. Cursor is an AI-native IDE with agents, model routing, and a VS Code-like workflow. GitHub Copilot is the GitHub-native coding layer that works across supported editors and connects more directly to issues, pull requests, and enterprise controls.
...
- [GitHub Copilot BYOK coverage](../news/2026-04-26-github-copilot-byok-vscode.md)
