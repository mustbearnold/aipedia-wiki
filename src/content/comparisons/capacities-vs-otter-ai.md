...
[Capacities](../tools/capacities.md) and [Otter.ai](../tools/otter-ai.md) both live in the AI notes category, but they solve different capture problems. Capacities is an object-based personal knowledge base. Otter.ai is a meeting assistant that records, transcribes, summarizes, and searches conversations.
