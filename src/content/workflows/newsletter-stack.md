...
| **Research model stack** | Perplexity synthesizes 19 models including Claude Opus 4.7 and OpenAI frontier models |
...
**Claude vs OpenAI frontier models for drafting?**
Opus 4.7 edits with more nuance; OpenAI's frontier stack is wordier on the same prompt. Claude wins blind draft tests ~8 out of 10 runs on this stack.
