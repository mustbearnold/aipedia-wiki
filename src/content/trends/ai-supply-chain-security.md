...
meta_description: "Updated June 10, 2026: AI security risk is moving into MCP servers, plugins, tool adapters, package changes, credentials, and agent permissions. Security reviews now need to cover every tool an agent can call."
...
- [GitHub Changelog: secret scanning with GitHub MCP Server](https://github.blog/changelog/2026-05-05-secret-scanning-with-github-mcp-server-is-now-generally-available/), verified 2026-06-10.
- [GitHub Changelog: dependency scanning with GitHub MCP Server](https://github.blog/changelog/2026-05-05-dependency-scanning-with-github-mcp-server-is-in-public-preview/), verified 2026-06-10.
- [GitHub Docs: scan for secrets with GitHub MCP Server](https://docs.github.com/en/code-security/how-tos/use-ghas-with-ai-coding-agents/scan-for-secrets-with-github-mcp-server), verified 2026-06-10.
- [Claude Code security docs](https://code.claude.com/docs/en/security), verified 2026-06-10.
- [OWASP Top 10 for Agentic Applications 2026](https://genai.owasp.org/resource/owasp-top-10-for-agentic-applications-for-2026/), verified 2026-06-10.
- [OpenAI Agents SDK guardrails](https://openai.github.io/openai-agents-python/guardrails/), verified 2026-06-10.
