...
meta_description: "Open-weight models like Llama 4, GLM-5.1, and Gemma 4 now match or beat GPT-5.4 on coding benchmarks. The 6-month lag between open and closed AI has collapsed in 2026."
...
Zhipu released **GLM-5.1** under an MIT license in Q1 2026. It beats GPT-5.4 on SWE-bench Pro coding benchmarks while costing nothing to run. Google released **Gemma 4 31B** under Apache 2.0, competing with models two to three times its parameter count.
...
**For enterprises:** Data sovereignty arguments that were premium pitches in 2024 ("run it on your own infra") are now commodity. Self-hosted Llama 4 behind a VPC offers capability comparable to GPT-5.4 at marginal cost per token.
...
**Builders:** Prototype on GPT-5.4 or Claude Opus 4.7 for speed, then evaluate whether GLM-5.1 or Llama 4 can replace them in production. The cost savings are now worth the evaluation time.
