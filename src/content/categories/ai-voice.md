...
Start with [ElevenLabs](/tools/elevenlabs/) for polished creator voice generation, cloning, dubbing, low-latency agents, and live STT; its May 2026 PAYG update lowered self-serve API and ElevenAgents rates, while Scribe v2 Realtime now matters for streaming transcription. The June 7 [ElevenLabs alternatives](/guides/elevenlabs-alternatives/) refresh keeps the switching map current: Cartesia is the real-time agent lane, Fish Audio is the API-value/open-model lane, WellSaid is the controlled business narration lane, Voxtral is the Mistral-native TTS/STT lane, and ElevenLabs remains the broad default when one account needs creator voice, cloning, dubbing, agents, and workflow polish. The June 8 [Kokoro](/tools/kokoro/) refresh keeps the local/open TTS lane honest: Kokoro is still a free Apache 2.0, 82M-parameter model, but the official model card warns that Kokoro-looking third-party domains can be unaffiliated or scammy, so download and source-check from Hugging Face/GitHub rather than a lookalike wrapper.

The June 6 [transcription guide](/guides/best-ai-for-transcription/) refresh keeps the STT fork practical: Fathom is the meeting-transcription default, Descript is the creator transcript-editing lane, Deepgram is the first developer STT API to test, AssemblyAI is the richer speech-understanding/diarization API lane, and ElevenLabs belongs in transcription conversations only when STT is part of a broader voice platform. The June 9 Riverside check keeps it in the remote-capture lane: Free is for testing, Pro is $29 monthly or $24/mo annual, Live is $39 monthly or $34/mo annual, Webinar is $99 monthly or $79/mo annual, and Business is custom, with checkout verification still prudent because the rendered pricing table repeats one annual-billing line. The June 6 [Resemble AI vs Voxtral](/compare/resemble-ai-vs-voxtral/) refresh makes the enterprise-vs-model-lane boundary explicit: choose Resemble AI when the buyer needs governed voice cloning, dubbing, watermarking, detection, approval workflow, and private/enterprise deployment; choose Voxtral when a Mistral-standardized product wants hosted Voxtral TTS, Mini Transcribe 2, Realtime STT, and open-model evaluation in one audio ecosystem.

The June 5 ElevenLabs comparison refresh keeps the rest of the lanes sharp: Fish Audio for technical API value and licensing-aware model experiments, HeyGen or Synthesia for avatar-led video, Murf for business narration plus Falcon/Gen2 API evaluation, Otter.ai for meeting capture, Resemble AI for governed custom voice and detection, Voxtral for Mistral-native TTS/STT, and WellSaid for controlled L&D narration. The June 5 Fish Audio comparison refresh clarifies two critical adjacent calls: choose Resemble AI over Fish when branded voices need localization, watermarking, detection, on-prem/private deployment, and stakeholder approval workflow; choose Voxtral over Fish when a Mistral-standardized product wants hosted Voxtral TTS plus Mini Transcribe 2 and Realtime STT in one audio ecosystem. Look at [MiniMax Speech](/tools/minimax-speech/) when hosted TTS price, Speech 2.8 API access, voice slots, RPM, and multilingual coverage matter; the June 8 check keeps Speech 2.8 HD/Turbo as current, pay-as-you-go at $60/M characters for Turbo and $100/M characters for HD, and Audio Subscription from $5/month to $999/month.

Add [Voxtral](/tools/voxtral/) to the shortlist when you already use Mistral and want hosted TTS at a published $0.016 per 1k characters plus Voxtral Mini Transcribe 2 and Realtime STT in the same model ecosystem. Use [Cartesia](/tools/cartesia/) Line or [Retell AI](/tools/retell-ai/) for low-latency voice agents; the June 18 Cartesia check keeps eligible Line agents on Sonic 3.5 TTS plus Ink 2 STT by default, adds bring-your-own Twilio account support, and keeps production cost modeling focused on Line from $0.06/min, TTS at 15 credits/sec, phone minutes, retries, and limited-time free LLM usage. The June 9 Retell check keeps pay-as-you-go at $0.07-$0.31/minute with 20 included concurrent calls, extra concurrency as a separate scaling cost, and a June 15, 2026 API migration risk for legacy list endpoints. Use [Hume AI](/tools/hume-ai/) when empathic voice behavior and Octave emotional TTS matter more than raw latency. Do not buy Hume for a new Expression Measurement project without a migration path: Hume docs say those endpoints were deprecated May 14, 2026 and become inaccessible June 14, 2026.

Use [CloudTalk](/tools/cloudtalk/) when the voice problem is a sales/support phone system with CRM sync, AI summaries, coaching, AI dialers, AI Receptionist, and a later AI Specialist path. The June 18 refresh keeps core pricing stable but adds buyer attention to Power/Parallel Dialer, AI agent minute bundles, Branded Caller ID, Spam Remediation, messaging, regional minutes, and call-consent governance. Use [MeetGeek](/tools/meetgeek/) when customer-facing meetings need 100+ language transcription, AI summaries, action items, AI Chat, and CRM/task automation; use [Fathom](/tools/fathom/) for the cleaner individual meeting-transcription default, while testing its bot-free Mac capture beta and Account-Wide Ask Fathom limits before team rollout. Use [Descript](/tools/descript/) for podcast/video transcription and editing: the June 5 comparison refresh confirms it beats ElevenLabs, Fish Audio, Resemble AI, and Voxtral when the job is transcript-first post-production rather than standalone TTS, open-weight generation, enterprise voice governance, or Mistral-native audio APIs. Use [Castmagic](/tools/castmagic/) for turning recorded audio into ready-to-publish content; the June 18 refresh adds Content Pipeline, Studio clipping/audiograms, iOS recording, semantic media-library search, and Castmagic MCP for Claude to the old show-notes story. Use [Deepgram](/tools/deepgram/), [AssemblyAI](/tools/assemblyai/), Voxtral Mini Transcribe 2, or Cartesia Ink 2 inside a Line/voice-agent stack when transcription is an API or product feature. Deepgram's June 6 transcription-guide recheck keeps the PAYG/Growth split clear: use self-serve for tests and move to Growth/Enterprise when production scale, support, discounts, and procurement matter. AssemblyAI's June 18 refresh keeps the key buyer split clear but changes the checklist: Universal 3.5 Pro is now a preview pre-recorded STT test, Voice Agent API is the one-WebSocket speech-to-speech lane at $4.50/hr, LLM Gateway has US/EU routing, and streaming bills by open session duration rather than audio sent.
...
- [Cartesia pricing](https://cartesia.ai/pricing) (verified 2026-06-18)
- [Cartesia Sonic 3.5 docs](https://docs.cartesia.ai/build-with-cartesia/tts-models/latest) (verified 2026-06-18)
- [Cartesia 2026 changelog](https://docs.cartesia.ai/changelog/2026) (verified 2026-06-18)
...
- [AssemblyAI pricing](https://www.assemblyai.com/pricing) (verified 2026-06-18)
- [AssemblyAI models docs](https://www.assemblyai.com/docs/getting-started/models) (verified 2026-06-18)
- [AssemblyAI Universal 3.5 Pro preview docs](https://www.assemblyai.com/docs/pre-recorded-audio/universal-3-5-pro) (verified 2026-06-18)
- [AssemblyAI billing and pricing docs](https://www.assemblyai.com/docs/billing-and-pricing) (verified 2026-06-18)
- [AssemblyAI LLM Gateway docs](https://www.assemblyai.com/docs/llm-gateway/overview) (verified 2026-06-18)
- [AssemblyAI Voice Agent API](https://www.assemblyai.com/products/voice-agent-api) (verified 2026-06-18)
