...
The June 4 research-discovery comparison pass refreshed [Connected Papers vs Consensus](/compare/connected-papers-vs-consensus/), [Connected Papers vs Elicit](/compare/connected-papers-vs-elicit/), [Connected Papers vs Semantic Scholar](/compare/connected-papers-vs-semantic-scholar/), [Consensus vs Elicit](/compare/consensus-vs-elicit/), and [Consensus vs Semantic Scholar](/compare/consensus-vs-semantic-scholar/). The buyer split is now explicit: Connected Papers maps a field, Consensus answers focused academic questions, Elicit manages systematic-review workflow, Scite checks citation context, Semantic Scholar is the free academic-search/API baseline, and [nanochat](/tools/nanochat/) is an educational LLM training harness rather than a paper-search product.
...
- [ChatPDF](https://www.chatpdf.com/), [PDF AI](https://www.chatpdf.com/pdf-ai), [AI Research](https://www.chatpdf.com/scholar), [YouTube Chat](https://www.chatpdf.com/youtube), and [backend API docs](https://www.chatpdf.com/docs/api/backend) - verified 2026-06-18.
