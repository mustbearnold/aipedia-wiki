...
date: 2026-04-26
severity: major
summary: "Anthropic published an update on election safeguards, adding another governance item to a week already dominated by frontier-model safety, agent commerce, and infrastructure commitments."
affects: [claude]
