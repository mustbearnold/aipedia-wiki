...
- [Replit Agent](/tools/replit-agent/): Replit's browser-based AI app builder, with Plan Mode, modes and effort controls, App Testing, Package Firewall, and integrated database, auth, and hosting.
...
- [Replit Agent](/tools/replit-agent/) for AIpedia's canonical product and pricing record.
