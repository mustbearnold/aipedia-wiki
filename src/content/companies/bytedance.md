...
ByteDance is the privately held Chinese technology company founded in 2012 by Zhang Yiming and Liang Rubo, best known globally as the parent of TikTok and Douyin. Beyond short video, it runs a large AI portfolio: the [Doubao](/tools/doubao/) assistant, the [Jimeng](/tools/jimeng/) and [Seedance](/tools/seedance/) generative media models, and the [Trae](/tools/trae/) AI coding tool, alongside CapCut and other apps. Reported private-market valuations reached roughly $550 billion in 2026, and the company is reported to be planning AI capital spending on the order of $70 billion for the year.
...
- [Doubao](/tools/doubao/): ByteDance's flagship AI assistant, among the most widely used chatbots in China.
- [Jimeng](/tools/jimeng/): Generative AI for image and video creation.
- [Seedance](/tools/seedance/): AI video generation.
- [Trae](/tools/trae/): AI coding tool from ByteDance.
...
- [Doubao](/tools/doubao/), [Jimeng](/tools/jimeng/), [Seedance](/tools/seedance/), and [Trae](/tools/trae/) for AIpedia's canonical product records.
- [ByteDance on Wikipedia](https://en.wikipedia.org/wiki/ByteDance) for corporate history and structure.
