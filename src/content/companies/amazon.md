...
Amazon is the public technology and cloud giant whose AI center of gravity is AWS. It ships the [Amazon Q](/tools/amazon-q/) assistant for business and developers, hosts third-party and first-party models through Amazon Bedrock, builds its own Nova model family, and is a major investor in Anthropic, whose Claude models run on AWS. Amazon's bet is to be the neutral cloud platform where enterprises build and run AI.
...
- [Amazon Q](/tools/amazon-q/): Amazon's AI assistant for business and software development, integrated with AWS.
...
- [Amazon Q](/tools/amazon-q/) for AIpedia's canonical product record.
- [AWS AI](https://aws.amazon.com/ai/) and [Amazon Bedrock](https://aws.amazon.com/bedrock/) for product and platform details.
- [Amazon investor relations](https://ir.aboutamazon.com/) for public-company status.
