...
The strategy leans on three advantages Musk controls: distribution through X, compute through large GPU clusters, and capital through tightly linked ventures. The February 2026 SpaceX acquisition deepens that integration, tying xAI's compute and capital story to Musk's broader holdings rather than a standalone path.

## Current Flagship Products

- [Grok](/tools/grok/): xAI's AI assistant, with real-time X and web search, Grok Imagine image and video generation, voice, and a coding surface. Grok 4.3 is the current default model, with SuperGrok subscription tiers and an API.
...
- [Grok](/tools/grok/) for AIpedia's canonical product and pricing record.
- [xAI official site](https://x.ai) for product and company information.
- Reuters and Yahoo Finance reporting (January to February 2026) for the Series E valuation and the SpaceX acquisition.
- [xAI model docs](https://docs.x.ai/developers/models) for current model details.
