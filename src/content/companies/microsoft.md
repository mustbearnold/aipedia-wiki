...
Microsoft is the public software and cloud giant that has woven AI across its entire product line, from Microsoft 365 Copilot to [GitHub Copilot](/tools/github-copilot/) and the [Microsoft Agent Framework](/tools/microsoft-agent-framework/) for building agents. Its AI strategy is anchored by a deep partnership with and investment in OpenAI, whose models power many Copilot surfaces, alongside Azure AI as the cloud platform for enterprises deploying AI.
...
- [GitHub Copilot](/tools/github-copilot/): The GitHub-native AI pair programmer across IDEs, the CLI, and code review (GitHub is a Microsoft subsidiary).
- [Microsoft Agent Framework](/tools/microsoft-agent-framework/): Microsoft's framework for building AI agents.
...
- [GitHub Copilot](/tools/github-copilot/) and [Microsoft Agent Framework](/tools/microsoft-agent-framework/) for AIpedia's canonical product records.
- [Microsoft AI](https://www.microsoft.com/en-us/ai) for product and Copilot information.
- [Microsoft investor relations](https://www.microsoft.com/en-us/investor) for public-company status and reporting.
