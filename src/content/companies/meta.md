...
- [Llama](/tools/llama/): Meta's open-weight large language model family, foundational to the open-source AI ecosystem.
...
- [Llama](/tools/llama/) for AIpedia's canonical model record.
- [Meta AI](https://ai.meta.com/) for model and product information.
- [Meta investor relations](https://investor.atmeta.com/) for public-company status.
