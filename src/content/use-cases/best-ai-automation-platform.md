...
[n8n](https://n8n.io/) is the best AI automation platform as of April 15, 2026. Self-hosted n8n costs $0; the cloud version starts at $20 per month for 2,500 executions. n8n provides a visual workflow builder with native nodes for AI agents that integrate with models like GPT-5.4, Claude Opus 4.7, and Gemini 3.1 Pro, plus 400+ app connections and code access for customization[1][3].
...
|------|-------|----------|------------------|-------------|-----------|-------|
| [n8n](../tools/n8n.md) | $0 (self-host) / $20/mo (cloud) | Technical solopreneurs, small teams | Native nodes for GPT-5.4, Claude Opus 4.7 | 400+ | Yes | 9.3/10 |
...
Zapier (core version 2026 Q1 update) builds Zaps with point-and-click steps across 7,000+ apps. No code required; setups take minutes. AI features use Central for chatbots, natural language Zap creation, and actions calling GPT-5.4 or Claude Opus 4.7 for tasks like summarization or extraction ([Zapier Integrations](https://zapier.com/apps)).
...
Relevance AI (2026 platform v3.2) centers on no-code agent teams with memory, tools, and GPT-5.4/Claude Opus 4.7 backends. Builds deployable agents for tasks like research, sales ([Relevance AI Pricing](https://relevanceai.com/pricing)).
