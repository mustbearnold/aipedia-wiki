...
## OpenAI API
OpenAI OpenAI API (2026-04-15) handles multimodal lead scoring via ChatGPT Plus/Pro ($20-200/mo). Processes text/images for ICP fit but trails Claude Opus 4.7 in structured B2B analysis (e.g., funding signals). Good for outreach drafts; n8n-compatible. Limitations: Higher token costs; less precise on long docs vs. Claude[1][2][3].
...
Claude Opus 4.7 for B2B depth; OpenAI frontier models if multimodal needed[1][4].

## Sources
- [n8n.io](https://n8n.io/) - Workflow tool with API nodes for lead gen.
- [docs.anthropic.com](https://docs.anthropic.com/) - Claude API Opus 4.7 docs, pricing.
