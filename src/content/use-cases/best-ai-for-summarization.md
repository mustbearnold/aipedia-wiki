...
Google's Gemini 3.1 Pro offers solid summarization with multimodal input (text, images, audio). It condenses web pages, PDFs, or YouTube videos into highlights, excels in real-time search-integrated summaries. Free access via gemini.google.com makes it accessible.

Free unlimited; Advanced $20/month for 3.1 Pro priority. API pricing mirrors ChatGPT levels, around $10-50/M tokens based on tier.[7]

Pros: Free high-quality tier; handles mixed media; Google ecosystem integration. Cons: Less consistent on niche topics; 2M token max but practical limits lower. Good for casual or budget users (152 words).
...
- [OpenAI API Pricing](https://openai.com/api/pricing/)[7]
- [OpenAI Developers Pricing Docs](https://developers.openai.com/api/docs/pricing)[7]
