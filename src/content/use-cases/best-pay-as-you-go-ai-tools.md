...
meta_description: "Updated June 27, 2026: compare true pay-as-you-go AI APIs and usage-based tools across LLMs, model routing, media generation, speech, voice, and budget controls."
...
- [Claude API pricing](https://docs.anthropic.com/en/docs/about-claude/pricing) (verified 2026-06-27)
- [Gemini API pricing](https://ai.google.dev/gemini-api/docs/pricing) (verified 2026-06-27)
- [OpenRouter pricing](https://openrouter.ai/pricing) (verified 2026-06-27)
- [Mistral AI pricing](https://mistral.ai/pricing) (verified 2026-06-27)
- [Groq pricing](https://groq.com/pricing) (verified 2026-06-27)
- [Replicate pricing](https://replicate.com/pricing) (verified 2026-06-27)
- [fal Model API pricing docs](https://fal.ai/docs/documentation/model-apis/pricing) (verified 2026-06-27)
...
- [Fish Audio pricing and rate limits](https://docs.fish.audio/developer-platform/models-pricing/pricing-and-rate-limits) (verified 2026-06-27)
