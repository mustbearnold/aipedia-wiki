...
guide_picks:
  best_overall:
    tool: perplexity
    label: "Best cited web research layer"
    plan: "Start free or Pro; evaluate Enterprise only when newsroom controls, files, and team spaces matter"
    reason: "Best first specialist for journalists because it puts source trails at the center of current web, company, policy, product, and public-record research."
    sources:
      - label: "Perplexity Enterprise pricing"
        url: "https://www.perplexity.ai/enterprise/pricing"
  budget:
    tool: notebooklm
    label: "Best source-grounded notebook"
    plan: "Start free; upgrade through Google AI, Google Cloud, or qualifying Workspace paths only if limits matter"
    reason: "Best way to question and summarize a controlled set of documents, interviews, transcripts, PDFs, reports, and source packs without wandering outside the provided corpus."
    sources:
      - label: "NotebookLM upgrade information"
        url: "https://support.google.com/notebooklm/answer/16213268"
  pro_team:
    tool: chatgpt
    label: "Best all-purpose reporting assistant"
    plan: "Use existing access first; require Advanced Account Security for high-risk accounts where available"
    reason: "Best broad workspace for drafting, summarizing, extracting, coding small analysis scripts, reviewing files, and turning reporting notes into outlines."
    sources:
...
**Use [Perplexity](/tools/perplexity/) first for current cited web research.** It is the best journalism-specific starting layer because source trails are visible by default. Use it to find primary documents, official statements, filings, product pages, court records, company pages, policy documents, and prior reporting. Do not cite the generated answer; cite the source.

**Use [NotebookLM](/tools/notebooklm/) when the story has a source pack.** NotebookLM is the safest research companion when you already have PDFs, interview transcripts, reports, hearings, emails, notes, or datasets and want answers grounded in that material. It is not a discovery engine for sources you did not upload.

**Use [ChatGPT](/tools/chatgpt/) as the broad reporting workspace.** It is useful for outlines, summaries, data-cleaning ideas, spreadsheet/code help, questions for interview prep, transcript cleanup, and draft structure. OpenAI's current Advanced Account Security launch is especially relevant for journalists, researchers, public officials, and other high-risk users.

**Use [Claude](/tools/claude/) for careful editing and narrative judgment.** Claude is strongest when the job is tightening a sensitive story, balancing tone, spotting unsupported leaps, building a chronology, or turning messy notes into a clean editor-ready memo.

**Use [Fathom](/tools/fathom/) only when recording is appropriate.** Meeting and interview notes are valuable, but recording consent, source safety, newsroom policy, and retention rules matter more than transcription convenience.

**Use [Grok](/tools/grok/) only for X-native signal checks.** X Premium+ currently lists higher Grok limits as a subscription benefit, and Grok's unique value is proximity to X discourse. Treat it as a social-signal tool, not a fact engine.

## Best Picks by Journalism Job

| Journalism job | Start with | Why | Watch out |
|---|---|---|---|
| Current web research and source trails | [Perplexity](/tools/perplexity/) | Fast cited paths to current public sources | Always inspect the primary source before publishing |
| Investigative source pack, transcripts, PDFs, reports | [NotebookLM](/tools/notebooklm/) | Answers stay grounded in uploaded/source-selected material | It cannot find what you did not add |
| Drafting, outlines, note cleanup, small analysis tasks | [ChatGPT](/tools/chatgpt/) | Broadest all-purpose workspace for reporting support | High-risk accounts should enable stronger security where available |
| Sensitive editing and narrative structure | [Claude](/tools/claude/) | Strong for careful prose, tone, chronology, and unsupported-claim checks | It is not a substitute for source verification |
| Interview and meeting capture | [Fathom](/tools/fathom/) | Saves raw call context, decisions, and quotes for later review | Get consent and follow source-protection rules |
| X/social narrative checks | [Grok](/tools/grok/) | Useful for seeing what is moving inside X conversations | X discourse can be manipulated, false, or unrepresentative |
| Google Workspace reporting | [Gemini](/tools/gemini/) | Useful near Docs, Sheets, Drive, Gmail, and Google AI plans | Verify plan, data, and newsroom policy before relying on it |
| Academic/science claim checking | [Scite](/tools/scite/), [Semantic Scholar](/tools/semantic-scholar/), [Elicit](/tools/elicit/) | Better source fit for papers, citations, and literature review | Still requires domain expertise and original paper inspection |
