...
guide_picks:
  ...
  pro_team:
    ...
    plan: "Perplexity Pro"
    reason: "Perplexity is the better Gemini alternative when the buyer needs source-backed web research, citation trails, and fast fact-checking more than a general chatbot."
    sources:
