...
export const ANSWER_GROUPS: AnswerGroup[] = [
  {
    ...
    items: [
      ...
      { slug: 'best-ai-research-tool-2026', q: 'What is the best AI research tool in 2026?', a: 'Elicit for systematic literature review, Consensus for evidence-backed answers, Scite for citation context, and Semantic Scholar for free discovery.' },
