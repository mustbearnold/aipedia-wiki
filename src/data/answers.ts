...
export const ANSWER_GROUPS: AnswerGroup[] = [
  {
    ...
    items: [
      ...
      { slug: 'best-ai-automation-tool-2026', q: 'What is the best AI automation tool in 2026?', a: 'Zapier for breadth, Make for visual budget builds, n8n for technical self-hosting, and Lindy for AI-agent automation.' },
    ],
  },
  {
