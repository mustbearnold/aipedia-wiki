...
|---|---:|---|---|
| Spec compliance audit | Partial | `.agent/meta/2026-06-30-agentic-tooling-meta-compliance.json`, Slice 81 evidence-overlap pilot documented above, Slice 82 fresh-telemetry pilot documented above, `.agent/loop-runs/2026-06-30-agentic-tooling-meta-slice-81.md`, `.agent/loop-runs/2026-06-30-agentic-tooling-meta-slice-82.md` | Keep updated after each slice. |
...
| Speed/token efficiency | Partial | six-worker workflows, timing receipts, loop `efficiency_metrics`, exact model-token usage in loop receipts, workflow/run/orchestrator/subagent model-token breakdowns, exact model-token summaries in trend receipts, deterministic routing-evaluation receipts, correction-telemetry receipts, telemetry-fed routing evaluations, multi-scenario routing suite receipts, positive exact request and total-token validation, `agent:closeout:check --require-efficiency-metrics`, derived efficiency formula validation, artifact-ref count validation, slowest-command validation, trend run-row source validation, trend slowest-command source validation, trend summary validation, trend stability and correction source validation, trend exact-token source validation, token context breakdown validation, correction-telemetry total validation, routing score recomputation, routing-suite aggregate recomputation, routing-suite v2 telemetry lineage refs, routing-policy conditional guardrails, routing-policy-pilot replay-only guardrails, routing-policy-pilot shared telemetry overlap guardrails, routing-policy-pilot fresh telemetry proof, `agent:efficiency:trends --out`, `agent:correction:telemetry --out`, `agent:routing:evaluate --out`, `agent:routing:suite --out`, `agent:routing:policy --out`, `agent:routing:pilot --out`, durable `aipedia.loop-efficiency-trends.v1` receipts, durable `aipedia.correction-telemetry.v1` receipts, durable `aipedia.agent-routing-evaluation.v1` receipts, durable `aipedia.agent-routing-evaluation-suite.v1/v2` receipts, durable `aipedia.agent-routing-policy.v1` receipts, durable `aipedia.agent-routing-policy-pilot.v1/v2` receipts, `agent:closeout:check` loop-efficiency-trends, correction-telemetry, routing-evaluation, routing-evaluation-suite, routing-policy, and routing-policy-pilot validation, `agent:meta:closeout:auto` efficiency-trends, correction-telemetry, routing-evaluation, routing-evaluation-suite, routing-policy, and routing-policy-pilot profiles, `stability_summary`, `correction_summary`, focused loop, closeout, router, trend, correction telemetry, routing, routing-suite, routing-policy, and routing-pilot tests, final auto-closeout-checked 3-run trend proof `.agent/evals/efficiency-trends-receipts/2026-06-30-slice-72-final-efficiency-trends.json`, correction telemetry proof `.agent/evals/correction-telemetry/2026-06-30-slice-73-correction-telemetry-receipt.json`, telemetry-fed routing proof `.agent/evals/routing-evaluations/2026-06-30-slice-73-routing-from-correction-telemetry-receipt.json`, routing-suite proof `.agent/evals/routing-suites/2026-06-30-slice-74-routing-suite-receipt.json` showing conditional routing with 4,920 exact-token delta and 3,600 ms wall-time delta across recommended choices, v2 lineage proof `.agent/evals/routing-suites/2026-06-30-slice-78-v2-telemetry-lineage-suite-receipt.json`, policy proof `.agent/evals/routing-policies/2026-06-30-slice-79-conditional-routing-policy-receipt.json`, replay-only policy-pilot proof `.agent/evals/routing-policy-pilots/2026-06-30-slice-80-policy-replay-pilot-receipt.json`, shared telemetry overlap policy-pilot proof `.agent/evals/routing-policy-pilots/2026-06-30-slice-81-shared-telemetry-overlap-pilot-receipt.json`, fresh telemetry policy-pilot proof `.agent/evals/routing-policy-pilots/2026-06-30-slice-82-fresh-telemetry-policy-pilot-receipt.json`, final Slice 81 trend proof `.agent/evals/efficiency-trends-receipts/2026-06-30-slice-81-final-efficiency-trends.json`, and final Slice 82 trend proof `.agent/evals/efficiency-trends-receipts/2026-06-30-slice-82-final-efficiency-trends.json` | Run one reviewer-pass receipt before changing defaults. |
