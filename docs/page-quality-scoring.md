...
Gold-set calibration turns scoring expectations into a regression gate. The committed baseline lives at `.agent/evals/score-calibration-goldset.json` and covers nine real routes:
