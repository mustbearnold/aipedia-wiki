...
function usage() {
  return [
    ...
    '',
    'Builds an aipedia.agent-routing-policy-pilot.v2 receipt by checking a routing policy against a bounded routing-suite receipt.',
    'Source-suite replays and shared-telemetry pilots are marked non-promotable, so they cannot be mistaken for independent workload pilots.',
    '',
    'Options:',
