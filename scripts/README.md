...
- `npm --silent run agent:proof:readiness -- --target page-refresh-policy --json`: read-only readiness check for bounded meta-goal proof pilots. It currently reports whether the positive page-refresh runner policy proof is blocked by stale generated inputs or dirty content boundaries.
