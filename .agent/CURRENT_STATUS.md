...
Latest affiliate move: `/guides/sanebox-pricing-for-heavy-inboxes/` is locally verified as an official-link buyer guide for heavy inboxes choosing between Appetizer, Snack, Lunch, and Dinner. It updates the SaneBox tool page, the heavy-inbox triage guide, AI Automation, five workflow pages, the recruiter guide and LinkedIn Recruiter tool/source rows after source-health caught LinkedIn HEAD false negatives, source registry, ledger, source-health checks, and commercial CTA audit tests. Focused gates passed: ledger generation, source health, commercial CTA and source-health tests, changed frontmatter, strict affiliate audit, ledger check, em dash guard, changed provenance, typecheck, diff check, `build:fast`, and route QA across 15 affected routes at 319, 360, 390, 430, 768, 1024, and 1366 px. Source health checked 262 URLs in 20.32s with 252 ok, 10 access-sensitive, 0 broken, and 0 unreachable. Route QA passed in 18.56s. Build passed in 16.73s, typecheck in 12.89s, focused tests in 1.81s, and strict affiliate audit passed with 42 money guides, 21 live affiliate tools, 0 errors, and 0 warnings. Accuracy/source and affiliate/trust reviewers both found must-fix issues and those were fixed; the visual subagent was interrupted before final review, so rendered route QA is the current visual evidence.
