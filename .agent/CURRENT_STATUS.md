...
- Branch: `master`. Active goal is the June 27 strict 3-day whole-site refresh target. Latest completed content batch is non-tool page-refresh batch 09. Latest workflow improvement is bounded page source-health timing, report-schema hardening, and company-prose overflow containment.
...
- Non-tool page-refresh batch 09 is verified locally: 22 company profiles and 2 guides were moved to June 27 verification. Anysphere was materially corrected for the reported June 2026 SpaceX/Cursor $60B stock acquisition agreement with live CBS/AP, Ars Technica, and Cursor sources replacing a timeout-prone Wikipedia source. Affected parents `/`, `/companies/`, `/guides/`, AI Writing, AI Notes, and AI Voice were updated or route-checked. Strict 3-day stale count is now 72 tracked pages.
...
Next page-refresh content move: continue the strict 3-day target from the regenerated queue. The remaining stale count after batch 09 is 72 tracked pages: 37 comparisons, 16 guides, 8 static pages, 6 tools, 2 companies, 1 workflow, 1 dead archive page, and 1 crawl surface.
