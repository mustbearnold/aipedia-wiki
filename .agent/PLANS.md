...
2. Use `correction_summary` during trend closeout before claiming speed changes also improved quality.
3. Use `.agent/evals/proof-readiness-receipts/2026-06-30-slice-47-proof-registry-state.json` as the durable blocked/proved-state receipt until content WIP is resolved.
