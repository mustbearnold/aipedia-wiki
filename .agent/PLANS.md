...
- Branch baseline: `master`; active goal is the June 27 strict 3-day whole-site refresh target. Latest content batch is non-tool page-refresh batch 07. Latest workflow improvement is bounded page source-health timing, report-schema hardening, and company-prose overflow containment.
...
- Non-tool page-refresh batch 07 is verified locally. It refreshed 4 trend routes, 12 workflow routes, 3 company profiles, and 5 dead-tool archives, repaired the source-health failures found in that batch, updated `/`, `/trends/`, `/workflows/`, `/companies/`, `/dead/`, AI Coding, `/llms.txt`, and `/llms-full.txt`, fixed company prose overflow at 319 px, and reduced the strict 3-day stale count from 145 to 120 tracked pages.
...
Continue the strict 3-day target from the regenerated queue. Remaining after batch 07: 120 tracked pages older than 2026-06-24, including 37 comparisons, 27 companies, 20 static pages, 19 guides, 3 trends, 2 workflows, 3 dead archive pages, 6 tools, 2 crawl surfaces, and 1 report.
