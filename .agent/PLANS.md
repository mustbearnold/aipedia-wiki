...
1. Use `.agent/evals/proof-readiness-receipts/2026-06-30-slice-46-proof-readiness-state.json` as the durable blocked/proved-state receipt until content WIP is resolved.
