...
- Branch baseline: `master`; latest content batch is non-tool page-refresh batch 03. Latest workflow improvement is bounded page source-health timing and report-schema hardening.
